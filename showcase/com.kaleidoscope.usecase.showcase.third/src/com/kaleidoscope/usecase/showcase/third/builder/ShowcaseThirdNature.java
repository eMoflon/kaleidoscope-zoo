...
public class ShowcaseThirdNature implements IProjectNature {

	public static final String SHOWCASE_THIRD_API_NATURE_ID = "com.kaleidoscope.usecase.showcase.third.nature";
	public static final String SHOWCASE_THIRD_API_BUILDER_ID = "com.kaleidoscope.usecase.showcase.third.builder";
	...
	private void addICryptoAPIProjectBuilder() throws CoreException {
		...
		command.setBuilderName(SHOWCASE_THIRD_API_BUILDER_ID);
