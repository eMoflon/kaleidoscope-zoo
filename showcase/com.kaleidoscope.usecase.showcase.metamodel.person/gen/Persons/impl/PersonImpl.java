 ...
 *   <li>{@link Persons.impl.PersonImpl#getID <em>ID</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class PersonImpl extends EObjectImpl implements Person {
	...
	public void setID(int newID) {
		...
		id = newID;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, PersonsPackage.PERSON__ID, oldID, id));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		...
		case PersonsPackage.PERSON__NAME:
			return getName();
		case PersonsPackage.PERSON__ID:
			return getID();
		}
