...
public class _RegistrationHelper {
	...
	public static void registerMetamodels(ResourceSet rs, OperationalStrategy strategy) {
		//rs.getURIConverter().getURIMap().put(URI.createURI("platform:/plugin/"), URI.createURI("platform:/resource/"));
		
		rs.getPackageRegistry().put("platform:/plugin/com.kaleidoscope.core.aux.simpletree/model/Simpletree.ecore", SimpletreePackageImpl.init());
