...
public class EmployeeImpl extends EObjectImpl implements Employee {
	...
	protected EClass eStaticClass() {
		return EmployeesPackage.Literals.EMPLOYEE;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EmployeesPackage.EMPLOYEE__NAME, oldName, name));
	}
	...
	public void setSalary(int newSalary) {
		...
		salary = newSalary;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EmployeesPackage.EMPLOYEE__SALARY, oldSalary,
					salary));
	}
	...
	public void setID(int newID) {
		...
		id = newID;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EmployeesPackage.EMPLOYEE__ID, oldID, id));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
		case EmployeesPackage.EMPLOYEE__NAME:
			return getName();
		case EmployeesPackage.EMPLOYEE__SALARY:
			return getSalary();
		case EmployeesPackage.EMPLOYEE__ID:
			return getID();
		}
