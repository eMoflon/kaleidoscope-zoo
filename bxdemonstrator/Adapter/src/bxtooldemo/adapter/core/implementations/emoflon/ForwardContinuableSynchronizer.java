...
public class ForwardContinuableSynchronizer extends ContinuableSynchronizer {

	public ForwardContinuableSynchronizer(CorrespondenceModel graphTriple, Delta delta,
