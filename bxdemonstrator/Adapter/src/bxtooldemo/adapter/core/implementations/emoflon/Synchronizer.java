...
import org.moflon.tgg.algorithm.synchronization.AmalgamationUtil;
...
public abstract class Synchronizer {
	...
	protected Graph toBeTranslated;

	protected Graph toBeDeleted;

	protected RulesTable lookupMethods;

	protected AmalgamationUtil amalgamationUtil;

	protected Collection<Match> inputMatchCollection;

	protected TIntCollection inputMatches;

	protected TIntCollection readyKernels;

	protected TIntCollection readyWithSiblingKernels;

	protected TIntCollection readyButUnreadySiblingsKernels;

	protected TIntCollection readyComplements;

	protected PrecedenceInputGraph pg;

	protected Collection<AttributeDelta> toBeChanged;

	protected Logger logger = Logger.getLogger(Synchronizer.class);

	// Debugger relevant fields
	protected Graph allRevokedElts;

	protected Graph addedElts;

	protected Collection<EObject> translated;

	protected Collection<TripleMatch> createdTripleMatchesInLastStep;
	...
	protected PerformRuleResult applyAndUpdateTriple(CorrespondenceModel graphTriple, IsApplicableMatch isApplMatch) {
	...
	protected Stream<Match> chooseOneMaximalSet() {
	...
	protected void extendReady(TIntCollection candidates) {
	...
	protected Collection<IsApplicableRuleResult> extendToFullMatches(Stream<Match> ready) {
	...
	protected void updateProcessedSets(IsApplicableMatch chosen) {
	...
	protected void processAmalgamationComplements(TIntCollection inputMatches, IsApplicableMatch chosen,
