...
public class BackwardContinuableSynchronizer extends ContinuableSynchronizer {

	public BackwardContinuableSynchronizer(CorrespondenceModel graphTriple, Delta delta,
			SynchronizationProtocol protocol, Configurator configurator, StaticAnalysis rules,
