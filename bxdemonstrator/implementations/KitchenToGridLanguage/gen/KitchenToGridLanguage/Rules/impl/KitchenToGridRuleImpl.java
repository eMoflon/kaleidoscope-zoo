...
public class KitchenToGridRuleImpl extends AbstractRuleImpl implements KitchenToGridRule {
	...
	public PerformRuleResult perform_FWD(IsApplicableMatch isApplicableMatch) {
		...
		Object[] result1_green = KitchenToGridRuleImpl
				.pattern_KitchenToGridRule_1_1_performtransformation_greenBFFB(grid, csp);
		...
		Object[] result2_black = KitchenToGridRuleImpl
				.pattern_KitchenToGridRule_1_2_collecttranslatedelements_blackBBB(grid, kitchen, kitchenToGrid);
		...
		Object[] result2_green = KitchenToGridRuleImpl
				.pattern_KitchenToGridRule_1_2_collecttranslatedelements_greenFBBB(grid, kitchen, kitchenToGrid);
		PerformRuleResult ruleresult = (PerformRuleResult) result2_green[0];

		Object[] result3_black = KitchenToGridRuleImpl
				.pattern_KitchenToGridRule_1_3_bookkeepingforedges_blackBBBB(ruleresult, grid, kitchen, kitchenToGrid);
		if (result3_black == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[ruleresult] = " + ruleresult
					+ ", " + "[grid] = " + grid + ", " + "[kitchen] = " + kitchen + ", " + "[kitchenToGrid] = "
					+ kitchenToGrid + ".");
		}
		KitchenToGridRuleImpl.pattern_KitchenToGridRule_1_3_bookkeepingforedges_greenBBBBFF(ruleresult, grid, kitchen,
				kitchenToGrid);
		...
		// 
		// 
		KitchenToGridRuleImpl.pattern_KitchenToGridRule_1_5_registerobjects_expressionBBBBB(this, ruleresult, grid,
	 ...
	 * @generated
	 */
	public void registerObjects_FWD(PerformRuleResult ruleresult, EObject grid, EObject kitchen,
	...
	public PerformRuleResult perform_BWD(IsApplicableMatch isApplicableMatch) {
		...
		Grid grid = (Grid) result1_green[0];
		KitchenToGridCorr kitchenToGrid = (KitchenToGridCorr) result1_green[2];

		Object[] result2_black = KitchenToGridRuleImpl
				.pattern_KitchenToGridRule_11_2_collecttranslatedelements_blackBBB(grid, kitchen, kitchenToGrid);
		if (result2_black == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[grid] = " + grid + ", "
					+ "[kitchen] = " + kitchen + ", " + "[kitchenToGrid] = " + kitchenToGrid + ".");
		}
		Object[] result2_green = KitchenToGridRuleImpl
				.pattern_KitchenToGridRule_11_2_collecttranslatedelements_greenFBBB(grid, kitchen, kitchenToGrid);
		PerformRuleResult ruleresult = (PerformRuleResult) result2_green[0];

		Object[] result3_black = KitchenToGridRuleImpl
				.pattern_KitchenToGridRule_11_3_bookkeepingforedges_blackBBBB(ruleresult, grid, kitchen, kitchenToGrid);
		if (result3_black == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[ruleresult] = " + ruleresult
					+ ", " + "[grid] = " + grid + ", " + "[kitchen] = " + kitchen + ", " + "[kitchenToGrid] = "
					+ kitchenToGrid + ".");
		}
		KitchenToGridRuleImpl.pattern_KitchenToGridRule_11_3_bookkeepingforedges_greenBBBBFF(ruleresult, grid, kitchen,
				kitchenToGrid);
		//nothing EMoflonEdge kitchenToGrid__kitchen____target = (EMoflonEdge) result3_green[4];
		//nothing EMoflonEdge kitchenToGrid__grid____source = (EMoflonEdge) result3_green[5];
		...
		// 
		// 
		KitchenToGridRuleImpl.pattern_KitchenToGridRule_11_5_registerobjects_expressionBBBBB(this, ruleresult, grid,
				kitchen, kitchenToGrid);
	 ...
	 * @generated
	 */
	public void registerObjects_BWD(PerformRuleResult ruleresult, EObject grid, EObject kitchen,
			EObject kitchenToGrid) {
		ruleresult.registerObject("grid", grid);
		ruleresult.registerObject("kitchen", kitchen);
		ruleresult.registerObject("kitchenToGrid", kitchenToGrid);
	 ...
	 * @generated
	 */
	public EObjectContainer isAppropriate_FWD_Grid_3(Grid grid) {
	 ...
	 * @generated
	 */
	public EObjectContainer isAppropriate_BWD_Kitchen_3(Kitchen kitchen) {
	...
	public IsApplicableRuleResult isApplicable_CC(Match sourceMatch, Match targetMatch) {
		...
		if (KitchenToGridRuleImpl.pattern_KitchenToGridRule_24_4_checkCSP_expressionFB(csp)) {
			...
			for (Object[] result5_black : KitchenToGridRuleImpl
				...
				KitchenToGridRuleImpl.pattern_KitchenToGridRule_24_6_createcorrespondence_greenBBFB(grid, kitchen,
						ccMatch);
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		...
		case RulesPackage.KITCHEN_TO_GRID_RULE___IS_APPROPRIATE_FWD_GRID_3__GRID:
			return isAppropriate_FWD_Grid_3((Grid) arguments.get(0));
		case RulesPackage.KITCHEN_TO_GRID_RULE___IS_APPROPRIATE_BWD_KITCHEN_3__KITCHEN:
			return isAppropriate_BWD_Kitchen_3((Kitchen) arguments.get(0));
	...
	public static final Object[] pattern_KitchenToGridRule_1_1_performtransformation_greenBFFB(Grid grid, CSP csp) {
		...
		return new Object[] { grid, kitchen, kitchenToGrid, csp };
	}

	public static final Object[] pattern_KitchenToGridRule_1_2_collecttranslatedelements_blackBBB(Grid grid,
			Kitchen kitchen, KitchenToGridCorr kitchenToGrid) {
		return new Object[] { grid, kitchen, kitchenToGrid };
	}

	public static final Object[] pattern_KitchenToGridRule_1_2_collecttranslatedelements_greenFBBB(Grid grid,
			Kitchen kitchen, KitchenToGridCorr kitchenToGrid) {
		...
		return new Object[] { ruleresult, grid, kitchen, kitchenToGrid };
	}

	public static final Object[] pattern_KitchenToGridRule_1_3_bookkeepingforedges_blackBBBB(
			PerformRuleResult ruleresult, EObject grid, EObject kitchen, EObject kitchenToGrid) {
	...
	public static final Object[] pattern_KitchenToGridRule_1_3_bookkeepingforedges_greenBBBBFF(
		...
		return new Object[] { ruleresult, grid, kitchen, kitchenToGrid, kitchenToGrid__kitchen____target,
	...
	public static final void pattern_KitchenToGridRule_1_5_registerobjects_expressionBBBBB(KitchenToGridRule _this,
			PerformRuleResult ruleresult, EObject grid, EObject kitchen, EObject kitchenToGrid) {
		_this.registerObjects_FWD(ruleresult, grid, kitchen, kitchenToGrid);
	...
	public static final Object[] pattern_KitchenToGridRule_11_2_collecttranslatedelements_blackBBB(Grid grid,
			Kitchen kitchen, KitchenToGridCorr kitchenToGrid) {
		return new Object[] { grid, kitchen, kitchenToGrid };
	}

	public static final Object[] pattern_KitchenToGridRule_11_2_collecttranslatedelements_greenFBBB(Grid grid,
			Kitchen kitchen, KitchenToGridCorr kitchenToGrid) {
		PerformRuleResult ruleresult = RuntimeFactory.eINSTANCE.createPerformRuleResult();
	...
	public static final void pattern_KitchenToGridRule_11_5_registerobjects_expressionBBBBB(KitchenToGridRule _this,
			PerformRuleResult ruleresult, EObject grid, EObject kitchen, EObject kitchenToGrid) {
		_this.registerObjects_BWD(ruleresult, grid, kitchen, kitchenToGrid);
	...
	public static final Object[] pattern_KitchenToGridRule_24_6_createcorrespondence_greenBBFB(Grid grid,
			Kitchen kitchen, CCMatch ccMatch) {
		KitchenToGridCorr kitchenToGrid = KitchenToGridLanguageFactory.eINSTANCE.createKitchenToGridCorr();
		kitchenToGrid.setTarget(kitchen);
		kitchenToGrid.setSource(grid);
		ccMatch.getCreateCorr().add(kitchenToGrid);
		return new Object[] { grid, kitchen, kitchenToGrid, ccMatch };
	}
