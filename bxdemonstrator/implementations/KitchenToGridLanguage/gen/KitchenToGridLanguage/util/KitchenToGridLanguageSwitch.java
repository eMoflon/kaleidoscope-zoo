/**
 */
package KitchenToGridLanguage.util;
 ...
 * @generated
 */
public class KitchenToGridLanguageSwitch<T> extends Switch<T> {
	/**
	 ...
	 * @generated
	 */
	protected static KitchenToGridLanguagePackage modelPackage;
	 ...
	 * @generated
	 */
	public KitchenToGridLanguageSwitch() {
		if (modelPackage == null) {
			modelPackage = KitchenToGridLanguagePackage.eINSTANCE;
		}
	}
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		...
		case KitchenToGridLanguagePackage.SOCKET_TO_GROUP_CORR: {
			...
			if (result == null)
				result = caseAbstractCorrespondence(socketToGroupCorr);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Socket To Group Corr</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Socket To Group Corr</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
