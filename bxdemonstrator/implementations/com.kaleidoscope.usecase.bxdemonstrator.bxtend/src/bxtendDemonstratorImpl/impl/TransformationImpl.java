 ...
 * </p>
 * <ul>
 *   <li>{@link bxtendDemonstratorImpl.impl.TransformationImpl#getCorrespondences <em>Correspondences</em>}</li>
 *   <li>{@link bxtendDemonstratorImpl.impl.TransformationImpl#getSourceModel <em>Source Model</em>}</li>
 *   <li>{@link bxtendDemonstratorImpl.impl.TransformationImpl#getTargetModel <em>Target Model</em>}</li>
 * </ul>
 *
 * @generated
 */
public class TransformationImpl extends MinimalEObjectImpl.Container implements Transformation {
	...
	protected EClass eStaticClass() {
		return BxtendDemonstratorImplPackage.Literals.TRANSFORMATION;
	}
	...
	public EList<Corr> getCorrespondences() {
		if (correspondences == null) {
			correspondences = new EObjectContainmentEList<Corr>(Corr.class, this, BxtendDemonstratorImplPackage.TRANSFORMATION__CORRESPONDENCES);
		}
		...
		if (sourceModel != null && sourceModel.eIsProxy()) {
			...
			if (sourceModel != oldSourceModel) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, BxtendDemonstratorImplPackage.TRANSFORMATION__SOURCE_MODEL, oldSourceModel, sourceModel));
			}
		}
		return sourceModel;
	}
	...
	public void setSourceModel(EObject newSourceModel) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, BxtendDemonstratorImplPackage.TRANSFORMATION__SOURCE_MODEL, oldSourceModel, sourceModel));
	}
	...
	public EObject getTargetModel() {
		if (targetModel != null && targetModel.eIsProxy()) {
			...
			if (targetModel != oldTargetModel) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, BxtendDemonstratorImplPackage.TRANSFORMATION__TARGET_MODEL, oldTargetModel, targetModel));
			}
		}
		return targetModel;
	}
	...
	public void setTargetModel(EObject newTargetModel) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, BxtendDemonstratorImplPackage.TRANSFORMATION__TARGET_MODEL, oldTargetModel, targetModel));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case BxtendDemonstratorImplPackage.TRANSFORMATION__CORRESPONDENCES:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case BxtendDemonstratorImplPackage.TRANSFORMATION__SOURCE_MODEL:
				if (resolve) return getSourceModel();
				return basicGetSourceModel();
			case BxtendDemonstratorImplPackage.TRANSFORMATION__TARGET_MODEL:
