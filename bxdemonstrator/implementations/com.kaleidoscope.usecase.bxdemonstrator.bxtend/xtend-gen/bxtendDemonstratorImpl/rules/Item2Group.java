...
public class Item2Group extends Elem2Elem {
  ...
  public boolean chkAddFridgeToCorrGroupPsbl(final Grid grid, final Block firstBlock, final Block secondBlock) {
    ...
    boolean _notEquals = (!Objects.equal(_n, null));
    if (_notEquals) {
      return false;
    }
    return true;
  ...
  public boolean chkAddingCorrGroupToHrzTablePsbl(final Grid grid, final Table table, final Group corrGroup) {
    ...
    if (((Objects.equal(firstBlock.getE(), null) || ((!Objects.equal(firstBlock.getIsOccupiedBy(), null)) && (!Objects.equal(firstBlock.getIsOccupiedBy(), corrGroup)))) || ((!Objects.equal(firstBlock.getE().getIsOccupiedBy(), null)) && (!Objects.equal(firstBlock.getE().getIsOccupiedBy(), corrGroup))))) {
      return false;
    }
    return true;
  }
  ...
  public boolean chkAddingCorrGroupToVertTablePsbl(final Grid grid, final Table table, final Group corrGroup) {
    ...
    Block _findFirst = IterableExtensions.<Block>findFirst(grid.getBlocks(), _function);
    Block firstBlock = ((Block) _findFirst);
    if (((Objects.equal(firstBlock.getS(), null) || ((!Objects.equal(firstBlock.getIsOccupiedBy(), null)) && (!Objects.equal(firstBlock.getIsOccupiedBy(), corrGroup)))) || ((!Objects.equal(firstBlock.getS().getIsOccupiedBy(), null)) && (!Objects.equal(firstBlock.getS().getIsOccupiedBy(), corrGroup))))) {
      return false;
    }
    return true;
  }
  ...
  public void targetToSource(final String s) {
    ...
    final Procedure1<Item> _function_1 = (Item f) -> {
      ...
      if (_notEquals) {
        if (((!Objects.equal(oldFirstBlock, null)) && (!Objects.equal(oldSecondBlock, null)))) {
        ...
        if (f instanceof Sink) {
          _matched=true;
          if (((((!Objects.equal(firstBlock.getW(), null)) || ((!Objects.equal(firstBlock.getIsOccupiedBy(), null)) && (!Objects.equal(firstBlock.getIsOccupiedBy(), corrGroup)))) || Objects.equal(firstBlock.getE(), null)) || ((!Objects.equal(firstBlock.getE().getIsOccupiedBy(), null)) && (!Objects.equal(firstBlock.getE().getIsOccupiedBy(), corrGroup))))) {
        ...
        if (!_matched) {
          if (f instanceof Fridge) {
            _matched=true;
            if ((((((!Objects.equal(firstBlock.getIsOccupiedBy(), null)) && (!Objects.equal(firstBlock.getIsOccupiedBy(), corrGroup))) || (!Objects.equal(firstBlock.getN(), null))) || 
              Objects.equal(firstBlock.getS(), null)) || ((!Objects.equal(firstBlock.getS().getIsOccupiedBy(), null)) && (!Objects.equal(firstBlock.getS().getIsOccupiedBy(), corrGroup))))) {
              throw new SynchronizationError();
            } else {
              firstBlockCorr.setSourceElement(firstBlock);
              ...
              if ((this.checkIfBlockIsOccupiedByOtherGroup(grid, g, firstBlock) || 
                ...
                if ((this.chkAddFridgeToCorrGroupPsbl(grid, firstBlock, secondBlock) && this.chkAddVertTableToCorrGroupPsbl(grid, firstBlock, secondBlock))) {
                  ...
                  final Procedure2<HashMap<String, EObject>, String> _function_1 = (HashMap<String, EObject> context, String decision) -> {
                    ...
                    boolean _equals_1 = decision.equals("create_a_fridge");
                    if (_equals_1) {
                      ...
                      boolean _equals_2 = decision.equals("create_a_vertical_table");
                      if (_equals_2) {
                  ...
                  if ((this.chkAddSinkToCorrGroupPsbl(grid, firstBlock, secondBlock) && this.chkAddHorzTableToCorrGroupPsbl(grid, firstBlock, secondBlock))) {
                    ...
                    final Procedure2<HashMap<String, EObject>, String> _function_2 = (HashMap<String, EObject> context, String decision) -> {
                      boolean _equals_1 = decision.equals("create_a_sink");
                      if (_equals_1) {
                        ...
                        boolean _equals_2 = decision.equals("create_a_horizontal_table");
                        if (_equals_2) {
                          Table table = KitchenLanguageFactory.eINSTANCE.createTable();
                          EObject _get_6 = context.get("firstBlock");
