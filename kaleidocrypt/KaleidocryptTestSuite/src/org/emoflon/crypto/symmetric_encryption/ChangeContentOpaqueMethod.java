...
public class ChangeContentOpaqueMethod extends CryptoTestCase{
	...
	public void test() throws InterruptedException, CoreException {
		...
		Path exptectedTargetPath = Paths.get(pathExpectedFolder.toString(),testName, "ChangeContentOpaqueMethod.java");
