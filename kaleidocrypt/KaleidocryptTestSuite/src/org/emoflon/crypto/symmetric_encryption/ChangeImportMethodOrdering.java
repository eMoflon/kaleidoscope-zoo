...
public class ChangeImportMethodOrdering extends CryptoTestCase{
	...
	public void test() throws InterruptedException, CoreException {
		...
		Path exptectedTargetPath = Paths.get(pathExpectedFolder.toString(),testName, "ChangeImportMethodOrdering.java");
		...
		//------------
		helperCryptoTest.performChangeSaveTargetEdit(relActualTargetPath, helperSimpleJava::changeImportsMethodsOrder);		
