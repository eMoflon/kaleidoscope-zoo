...
public class AddOpaqueMethod extends CryptoTestCase{
	...
	public void test() throws InterruptedException, CoreException {
		...
		Path exptectedTargetPath = Paths.get(pathExpectedFolder.toString(),testName, "AddOpaqueMethod.java");
		...
		//------------
		helperCryptoTest.performChangeSaveTargetEdit(relActualTargetPath, helperSimpleJava::addOpaqueMethod);
