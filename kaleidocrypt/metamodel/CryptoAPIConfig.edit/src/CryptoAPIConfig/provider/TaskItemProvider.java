...
/**
 * This is the item provider adapter for a {@link CryptoAPIConfig.Task} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class TaskItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider,
	...
	protected void addPackagePropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Task_package_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Task_package_feature", "_UI_Task_type"),
						CryptoAPIConfigPackage.Literals.TASK__PACKAGE, true, false, false,
		...
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						...
						getString("_UI_PropertyDescriptor_description", "_UI_Task_description_feature",
								"_UI_Task_type"),
						CryptoAPIConfigPackage.Literals.TASK__DESCRIPTION, true, false, false,
						ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
	}
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(CryptoAPIConfigPackage.Literals.TASK__ALGORITHMS);
		}
	...
	public String getText(Object object) {
		String label = ((Task) object).getPackage();
	...
	public void notifyChanged(Notification notification) {
		...
		case CryptoAPIConfigPackage.TASK__PACKAGE:
		case CryptoAPIConfigPackage.TASK__DESCRIPTION:
			fireNotifyChanged(new ViewerNotification(notification, notification.getNotifier(), false, true));
			return;
		case CryptoAPIConfigPackage.TASK__ALGORITHMS:
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add(createChildParameter(CryptoAPIConfigPackage.Literals.TASK__ALGORITHMS,
