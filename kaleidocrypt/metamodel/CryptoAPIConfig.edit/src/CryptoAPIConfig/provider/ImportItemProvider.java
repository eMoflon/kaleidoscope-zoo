...
/**
 * This is the item provider adapter for a {@link CryptoAPIConfig.Import} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ImportItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider,
	...
	protected void addValuePropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Import_value_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Import_value_feature", "_UI_Import_type"),
						CryptoAPIConfigPackage.Literals.IMPORT__VALUE, true, false, false,
	...
	public String getText(Object object) {
		String label = ((Import) object).getValue();
	...
	public void notifyChanged(Notification notification) {
		...
		case CryptoAPIConfigPackage.IMPORT__VALUE:
