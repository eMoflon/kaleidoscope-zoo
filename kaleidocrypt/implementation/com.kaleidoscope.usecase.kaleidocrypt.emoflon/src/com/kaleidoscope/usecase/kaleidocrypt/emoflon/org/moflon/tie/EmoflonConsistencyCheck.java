...
public class EmoflonConsistencyCheck extends SynchronizationHelper{

   public EmoflonConsistencyCheck()
   {
	...
	public static void main(String[] args) throws IOException {
        ...
        EmoflonConsistencyCheck helper = new EmoflonConsistencyCheck();
