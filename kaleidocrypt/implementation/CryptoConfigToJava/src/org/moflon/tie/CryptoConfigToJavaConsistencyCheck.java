...
public class CryptoConfigToJavaConsistencyCheck extends SynchronizationHelper{

   public CryptoConfigToJavaConsistencyCheck()
   {
	...
	public static void main(String[] args) throws IOException {
        ...
        CryptoConfigToJavaConsistencyCheck helper = new CryptoConfigToJavaConsistencyCheck();
