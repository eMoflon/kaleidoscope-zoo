...
public class CryptoConfigToJavaModelGen extends SynchronizationHelper{

   public CryptoConfigToJavaModelGen()
   {
	...
	public static void main(String[] args) throws IOException {
		...
		ModelGenerator gen = new ModelGenerator(CryptoConfigToJavaPackage.eINSTANCE, controller);
		gen.generate();
	}
}