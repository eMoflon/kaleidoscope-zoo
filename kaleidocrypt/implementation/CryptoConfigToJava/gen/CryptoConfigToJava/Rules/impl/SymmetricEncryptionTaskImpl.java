...
public class SymmetricEncryptionTaskImpl extends AbstractRuleImpl implements SymmetricEncryptionTask {
	...
	public PerformRuleResult perform_FWD(IsApplicableMatch isApplicableMatch) {
		...
		Object[] result1_green = SymmetricEncryptionTaskImpl
				.pattern_SymmetricEncryptionTask_1_1_performtransformation_greenFFFFFFFBFFFFFBFB(sbc, task, csp);
		JavaLiteral exprNameModePadding = (JavaLiteral) result1_green[0];
		JavaMethodInvocation exprRetPerformEncryption = (JavaMethodInvocation) result1_green[1];
		JavaVariableDeclaration keyEncryption = (JavaVariableDeclaration) result1_green[2];
		JavaName exprDataName = (JavaName) result1_green[3];
		JavaPackage javaPackage = (JavaPackage) result1_green[4];
		SymmetricBlockCipherToJcu sbc2Jcu = (SymmetricBlockCipherToJcu) result1_green[5];
		JavaVariableDeclaration dataEncryption = (JavaVariableDeclaration) result1_green[6];
		JavaName exprKeyName = (JavaName) result1_green[8];
		...
		JavaOpaqueMethod methodPerformEncryption = (JavaOpaqueMethod) result1_green[12];
		JavaStatement statRetPerformEncryption = (JavaStatement) result1_green[14];

		Object[] result2_black = SymmetricEncryptionTaskImpl
				.pattern_SymmetricEncryptionTask_1_2_collecttranslatedelements_blackBBBBBBBBBBBBBBB(exprNameModePadding,
						exprRetPerformEncryption, keyEncryption, exprDataName, javaPackage, sbc2Jcu, dataEncryption,
						sbc, exprKeyName, methodEncryption, t2c, jcu, methodPerformEncryption, task,
						statRetPerformEncryption);
		if (result2_black == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[exprNameModePadding] = "
					+ exprNameModePadding + ", " + "[exprRetPerformEncryption] = " + exprRetPerformEncryption + ", "
					+ "[keyEncryption] = " + keyEncryption + ", " + "[exprDataName] = " + exprDataName + ", "
					+ "[javaPackage] = " + javaPackage + ", " + "[sbc2Jcu] = " + sbc2Jcu + ", " + "[dataEncryption] = "
					+ dataEncryption + ", " + "[sbc] = " + sbc + ", " + "[exprKeyName] = " + exprKeyName + ", "
					+ "[methodEncryption] = " + methodEncryption + ", " + "[t2c] = " + t2c + ", " + "[jcu] = " + jcu
					+ ", " + "[methodPerformEncryption] = " + methodPerformEncryption + ", " + "[task] = " + task + ", "
					+ "[statRetPerformEncryption] = " + statRetPerformEncryption + ".");
		}
		Object[] result2_green = SymmetricEncryptionTaskImpl
				.pattern_SymmetricEncryptionTask_1_2_collecttranslatedelements_greenFBBBBBBBBBBBBBBB(
						exprNameModePadding, exprRetPerformEncryption, keyEncryption, exprDataName, javaPackage,
						sbc2Jcu, dataEncryption, sbc, exprKeyName, methodEncryption, t2c, jcu, methodPerformEncryption,
						task, statRetPerformEncryption);
		...
		if (result3_black == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[ruleresult] = " + ruleresult
					...
					+ "[sbc2Jcu] = " + sbc2Jcu + ", " + "[dataEncryption] = " + dataEncryption + ", " + "[sbc] = " + sbc
					+ ", " + "[exprKeyName] = " + exprKeyName + ", " + "[methodEncryption] = " + methodEncryption + ", "
					+ "[t2c] = " + t2c + ", " + "[jcu] = " + jcu + ", " + "[methodPerformEncryption] = "
					+ methodPerformEncryption + ", " + "[task] = " + task + ", " + "[statRetPerformEncryption] = "
					+ statRetPerformEncryption + ".");
		}
		SymmetricEncryptionTaskImpl
				.pattern_SymmetricEncryptionTask_1_3_bookkeepingforedges_greenBBBBBBBBBBBBBBBBFFFFFFFFFFFFFFF(
						ruleresult, exprNameModePadding, exprRetPerformEncryption, keyEncryption, exprDataName,
						javaPackage, sbc2Jcu, dataEncryption, sbc, exprKeyName, methodEncryption, t2c, jcu,
						methodPerformEncryption, task, statRetPerformEncryption);
		//nothing EMoflonEdge exprRetPerformEncryption__exprKeyName____arguments = (EMoflonEdge) result3_green[16];
		//nothing EMoflonEdge exprRetPerformEncryption__exprNameModePadding____arguments = (EMoflonEdge) result3_green[17];
		//nothing EMoflonEdge exprRetPerformEncryption__exprDataName____arguments = (EMoflonEdge) result3_green[18];
		//nothing EMoflonEdge javaPackage__jcu____cunits = (EMoflonEdge) result3_green[19];
		//nothing EMoflonEdge t2c__javaPackage____target = (EMoflonEdge) result3_green[20];
		//nothing EMoflonEdge sbc2Jcu__jcu____target = (EMoflonEdge) result3_green[21];
		//nothing EMoflonEdge jcu__methodPerformEncryption____methods = (EMoflonEdge) result3_green[22];
		//nothing EMoflonEdge sbc2Jcu__sbc____source = (EMoflonEdge) result3_green[23];
		//nothing EMoflonEdge methodEncryption__dataEncryption____params = (EMoflonEdge) result3_green[24];
		//nothing EMoflonEdge jcu__methodEncryption____methods = (EMoflonEdge) result3_green[25];
		//nothing EMoflonEdge methodEncryption__statRetPerformEncryption____statements = (EMoflonEdge) result3_green[26];
		//nothing EMoflonEdge t2c__task____source = (EMoflonEdge) result3_green[27];
		//nothing EMoflonEdge task__sbc____algorithms = (EMoflonEdge) result3_green[28];
		//nothing EMoflonEdge methodEncryption__keyEncryption____params = (EMoflonEdge) result3_green[29];
		//nothing EMoflonEdge statRetPerformEncryption__exprRetPerformEncryption____expr = (EMoflonEdge) result3_green[30];

		// 
		// 
		SymmetricEncryptionTaskImpl.pattern_SymmetricEncryptionTask_1_5_registerobjects_expressionBBBBBBBBBBBBBBBBB(
				this, ruleresult, exprNameModePadding, exprRetPerformEncryption, keyEncryption, exprDataName,
				javaPackage, sbc2Jcu, dataEncryption, sbc, exprKeyName, methodEncryption, t2c, jcu,
				methodPerformEncryption, task, statRetPerformEncryption);
	...
	public CSP isApplicable_solveCsp_FWD(IsApplicableMatch isApplicableMatch, SymmetricBlockCipher sbc, Task task) {// Create CSP
		...
		literal3.setValue("byte[] data,SecretKey key,String encryptPassingArgument");
		literal3.setType("");
		...
		setDefaultStringIfNull_0.solve(var_methodEncryption_index, literal1);
		...
		setDefaultStringIfNull_2.solve(var_exprNameModePadding_index, literal2);
		setDefaultStringIfNull_3.setRuleName("NoRuleName");
		setDefaultStringIfNull_3.solve(var_methodPerformEncryption_parameters, literal3);
		setDefaultStringIfNull_4.setRuleName("NoRuleName");
		setDefaultStringIfNull_4.solve(var_exprKeyName_identifier, literal4);
		...
		setDefaultStringIfNull_6.solve(var_exprKeyName_index, literal1);
		setDefaultStringIfNull_7.setRuleName("NoRuleName");
		setDefaultStringIfNull_7.solve(var_exprDataName_identifier, literal6);
		setDefaultStringIfNull_8.setRuleName("NoRuleName");
		setDefaultStringIfNull_8.solve(var_methodEncryption_modifier, literal7);
		setDefaultStringIfNull_9.setRuleName("NoRuleName");
		setDefaultStringIfNull_9.solve(var_methodPerformEncryption_modifier, literal8);
		setDefaultStringIfNull_10.setRuleName("NoRuleName");
		setDefaultStringIfNull_10.solve(var_methodEncryption_name, literal9);
		...
		setDefaultStringIfNull_12.solve(var_methodPerformEncryption_index, literal11);
		setDefaultStringIfNull_13.setRuleName("NoRuleName");
		setDefaultStringIfNull_13.solve(var_jcu_name, literal12);
		setDefaultStringIfNull_14.setRuleName("NoRuleName");
		setDefaultStringIfNull_14.solve(var_exprDataName_index, literal11);
	 ...
	 * @generated
	 */
	public void registerObjects_FWD(PerformRuleResult ruleresult, EObject exprNameModePadding,
	 ...
	 * @generated
	 */
	public boolean isAppropriate_BWD(Match match, JavaLiteral exprNameModePadding,
		...
		Object[] result1_black = SymmetricEncryptionTaskImpl
				.pattern_SymmetricEncryptionTask_10_1_initialbindings_blackBBBBBBBBBBBBB(this, match,
						exprNameModePadding, exprRetPerformEncryption, keyEncryption, exprDataName, javaPackage,
						dataEncryption, exprKeyName, methodEncryption, jcu, methodPerformEncryption,
						statRetPerformEncryption);
		if (result1_black == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
					+ "[match] = " + match + ", " + "[exprNameModePadding] = " + exprNameModePadding + ", "
					+ "[exprRetPerformEncryption] = " + exprRetPerformEncryption + ", " + "[keyEncryption] = "
					+ keyEncryption + ", " + "[exprDataName] = " + exprDataName + ", " + "[javaPackage] = "
					+ javaPackage + ", " + "[dataEncryption] = " + dataEncryption + ", " + "[exprKeyName] = "
		...
		if (SymmetricEncryptionTaskImpl.pattern_SymmetricEncryptionTask_10_3_CheckCSP_expressionFBB(this, csp)) {
			...
			if (result4_black == null) {
				throw new RuntimeException("Pattern matching failed." + " Variables: " + "[match] = " + match + ", "
						...
						+ exprRetPerformEncryption + ", " + "[keyEncryption] = " + keyEncryption + ", "
						+ "[exprDataName] = " + exprDataName + ", " + "[javaPackage] = " + javaPackage + ", "
						+ "[dataEncryption] = " + dataEncryption + ", " + "[exprKeyName] = " + exprKeyName + ", "
			...
			SymmetricEncryptionTaskImpl
					.pattern_SymmetricEncryptionTask_10_4_collectelementstobetranslated_greenBBBBBBBBBBBBFFFFFFFFFF(
							match, exprNameModePadding, exprRetPerformEncryption, keyEncryption, exprDataName,
							javaPackage, dataEncryption, exprKeyName, methodEncryption, jcu, methodPerformEncryption,
							statRetPerformEncryption);
			//nothing EMoflonEdge exprRetPerformEncryption__exprKeyName____arguments = (EMoflonEdge) result4_green[12];
			...
			//nothing EMoflonEdge jcu__methodEncryption____methods = (EMoflonEdge) result4_green[18];
			//nothing EMoflonEdge methodEncryption__statRetPerformEncryption____statements = (EMoflonEdge) result4_green[19];
			//nothing EMoflonEdge methodEncryption__keyEncryption____params = (EMoflonEdge) result4_green[20];
			//nothing EMoflonEdge statRetPerformEncryption__exprRetPerformEncryption____expr = (EMoflonEdge) result4_green[21];
	...
	public PerformRuleResult perform_BWD(IsApplicableMatch isApplicableMatch) {
		...
		JavaLiteral exprNameModePadding = (JavaLiteral) result1_bindingAndBlack[0];
		...
		JavaPackage javaPackage = (JavaPackage) result1_bindingAndBlack[4];
		...
		JavaOpaqueMethod methodPerformEncryption = (JavaOpaqueMethod) result1_bindingAndBlack[9];
		JavaStatement statRetPerformEncryption = (JavaStatement) result1_bindingAndBlack[10];
		...
		Object[] result2_black = SymmetricEncryptionTaskImpl
				.pattern_SymmetricEncryptionTask_11_2_collecttranslatedelements_blackBBBBBBBBBBBBBBB(
						exprNameModePadding, exprRetPerformEncryption, keyEncryption, exprDataName, javaPackage,
						sbc2Jcu, dataEncryption, sbc, exprKeyName, methodEncryption, t2c, jcu, methodPerformEncryption,
						task, statRetPerformEncryption);
		if (result2_black == null) {
		...
		Object[] result2_green = SymmetricEncryptionTaskImpl
				.pattern_SymmetricEncryptionTask_11_2_collecttranslatedelements_greenFBBBBBBBBBBBBBBB(
						exprNameModePadding, exprRetPerformEncryption, keyEncryption, exprDataName, javaPackage,
						sbc2Jcu, dataEncryption, sbc, exprKeyName, methodEncryption, t2c, jcu, methodPerformEncryption,
						task, statRetPerformEncryption);
		PerformRuleResult ruleresult = (PerformRuleResult) result2_green[0];
	...
	public IsApplicableRuleResult isApplicable_BWD(Match match) {
		...
		JavaLiteral exprNameModePadding = (JavaLiteral) result2_binding[0];
		...
		JavaPackage javaPackage = (JavaPackage) result2_binding[4];
		...
		JavaOpaqueMethod methodPerformEncryption = (JavaOpaqueMethod) result2_binding[9];
		JavaStatement statRetPerformEncryption = (JavaStatement) result2_binding[10];
		for (Object[] result2_black : SymmetricEncryptionTaskImpl
				.pattern_SymmetricEncryptionTask_12_2_corematch_blackBBBBBBBBBBBB(exprNameModePadding,
						exprRetPerformEncryption, keyEncryption, exprDataName, javaPackage, dataEncryption, exprKeyName,
						methodEncryption, jcu, methodPerformEncryption, statRetPerformEncryption, match)) {
			// ForEach 
			for (Object[] result3_black : SymmetricEncryptionTaskImpl
					.pattern_SymmetricEncryptionTask_12_3_findcontext_blackBBBBBBBBBBB(exprNameModePadding,
							exprRetPerformEncryption, keyEncryption, exprDataName, javaPackage, dataEncryption,
							exprKeyName, methodEncryption, jcu, methodPerformEncryption, statRetPerformEncryption)) {
				Object[] result3_green = SymmetricEncryptionTaskImpl
						.pattern_SymmetricEncryptionTask_12_3_findcontext_greenBBBBBBBBBBBFFFFFFFFFFF(
								exprNameModePadding, exprRetPerformEncryption, keyEncryption, exprDataName, javaPackage,
								dataEncryption, exprKeyName, methodEncryption, jcu, methodPerformEncryption,
								statRetPerformEncryption);
				IsApplicableMatch isApplicableMatch = (IsApplicableMatch) result3_green[11];
				//nothing EMoflonEdge exprRetPerformEncryption__exprKeyName____arguments = (EMoflonEdge) result3_green[12];
				...
				//nothing EMoflonEdge jcu__methodEncryption____methods = (EMoflonEdge) result3_green[18];
				//nothing EMoflonEdge methodEncryption__statRetPerformEncryption____statements = (EMoflonEdge) result3_green[19];
				//nothing EMoflonEdge methodEncryption__keyEncryption____params = (EMoflonEdge) result3_green[20];
				...
				Object[] result4_bindingAndBlack = SymmetricEncryptionTaskImpl
						.pattern_SymmetricEncryptionTask_12_4_solveCSP_bindingAndBlackFBBBBBBBBBBBBB(this,
								isApplicableMatch, exprNameModePadding, exprRetPerformEncryption, keyEncryption,
								exprDataName, javaPackage, dataEncryption, exprKeyName, methodEncryption, jcu,
								methodPerformEncryption, statRetPerformEncryption);
				if (result4_bindingAndBlack == null) {
					throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
							+ "[isApplicableMatch] = " + isApplicableMatch + ", " + "[exprNameModePadding] = "
							+ exprNameModePadding + ", " + "[exprRetPerformEncryption] = " + exprRetPerformEncryption
							+ ", " + "[keyEncryption] = " + keyEncryption + ", " + "[exprDataName] = " + exprDataName
							+ ", " + "[javaPackage] = " + javaPackage + ", " + "[dataEncryption] = " + dataEncryption
							+ ", " + "[exprKeyName] = " + exprKeyName + ", " + "[methodEncryption] = "
							+ methodEncryption + ", " + "[jcu] = " + jcu + ", " + "[methodPerformEncryption] = "
							+ methodPerformEncryption + ", " + "[statRetPerformEncryption] = "
							+ statRetPerformEncryption + ".");
				}
				CSP csp = (CSP) result4_bindingAndBlack[0];
	 ...
	 * @generated
	 */
	public void registerObjectsToMatch_BWD(Match match, JavaLiteral exprNameModePadding,
			JavaMethodInvocation exprRetPerformEncryption, JavaVariableDeclaration keyEncryption, JavaName exprDataName,
			JavaPackage javaPackage, JavaVariableDeclaration dataEncryption, JavaName exprKeyName,
			JavaWorkflowMethod methodEncryption, JavaCompilationUnit jcu, JavaOpaqueMethod methodPerformEncryption,
			JavaStatement statRetPerformEncryption) {
	 ...
	 * @generated
	 */
	public CSP isAppropriate_solveCsp_BWD(Match match, JavaLiteral exprNameModePadding,
			JavaMethodInvocation exprRetPerformEncryption, JavaVariableDeclaration keyEncryption, JavaName exprDataName,
			JavaPackage javaPackage, JavaVariableDeclaration dataEncryption, JavaName exprKeyName,
			JavaWorkflowMethod methodEncryption, JavaCompilationUnit jcu, JavaOpaqueMethod methodPerformEncryption,
			JavaStatement statRetPerformEncryption) {// Create CSP
		CSP csp = CspFactory.eINSTANCE.createCSP();
	 ...
	 * @generated
	 */
	public CSP isApplicable_solveCsp_BWD(IsApplicableMatch isApplicableMatch, JavaLiteral exprNameModePadding,
			JavaMethodInvocation exprRetPerformEncryption, JavaVariableDeclaration keyEncryption, JavaName exprDataName,
			JavaPackage javaPackage, JavaVariableDeclaration dataEncryption, JavaName exprKeyName,
			JavaWorkflowMethod methodEncryption, JavaCompilationUnit jcu, JavaOpaqueMethod methodPerformEncryption,
			JavaStatement statRetPerformEncryption) {// Create CSP
	 ...
	 * @generated
	 */
	public void registerObjects_BWD(PerformRuleResult ruleresult, EObject exprNameModePadding,
			EObject exprRetPerformEncryption, EObject keyEncryption, EObject exprDataName, EObject javaPackage,
			EObject sbc2Jcu, EObject dataEncryption, EObject sbc, EObject exprKeyName, EObject methodEncryption,
			EObject t2c, EObject jcu, EObject methodPerformEncryption, EObject task, EObject statRetPerformEncryption) {
		ruleresult.registerObject("exprNameModePadding", exprNameModePadding);
	 ...
	 * @generated
	 */
	public EObjectContainer isAppropriate_BWD_EMoflonEdge_6(EMoflonEdge _edge_arguments) {
		...
		for (Object[] result2_black : SymmetricEncryptionTaskImpl
			...
			JavaLiteral exprNameModePadding = (JavaLiteral) result2_black[0];
			...
			JavaPackage javaPackage = (JavaPackage) result2_black[4];
			...
			JavaOpaqueMethod methodPerformEncryption = (JavaOpaqueMethod) result2_black[9];
			JavaStatement statRetPerformEncryption = (JavaStatement) result2_black[10];
			Object[] result2_green = SymmetricEncryptionTaskImpl
			...
			if (SymmetricEncryptionTaskImpl
					.pattern_SymmetricEncryptionTask_21_3_bookkeepingwithgenericisAppropriatemethod_expressionFBBBBBBBBBBBBB(
							this, match, exprNameModePadding, exprRetPerformEncryption, keyEncryption, exprDataName,
							javaPackage, dataEncryption, exprKeyName, methodEncryption, jcu, methodPerformEncryption,
							statRetPerformEncryption)) {
				// 
				if (SymmetricEncryptionTaskImpl
	...
	public AttributeConstraintsRuleResult checkAttributes_FWD(TripleMatch __tripleMatch) {
		...
		var_literal4.setValue("byte[] data,SecretKey key,String encryptPassingArgument");
		...
		setDefaultStringIfNull0.solve(var_task_package, var_literal7);

		setDefaultStringIfNull1.setRuleName("SymmetricEncryptionTask");
		setDefaultStringIfNull1.solve(var_methodEncryption_throws, var_literal0);

		setDefaultStringIfNull2.setRuleName("SymmetricEncryptionTask");
		setDefaultStringIfNull2.solve(var_methodEncryption_index, var_literal1);

		setDefaultStringIfNull3.setRuleName("SymmetricEncryptionTask");
		setDefaultStringIfNull3.solve(var_methodPerformEncryption_throws, var_literal0);

		setDefaultStringIfNull4.setRuleName("SymmetricEncryptionTask");
		setDefaultStringIfNull4.solve(var_exprNameModePadding_index, var_literal2);

		setDefaultStringIfNull5.setRuleName("SymmetricEncryptionTask");
		setDefaultStringIfNull5.solve(var_methodPerformEncryption_parameters, var_literal4);

		setDefaultStringIfNull6.setRuleName("SymmetricEncryptionTask");
		setDefaultStringIfNull6.solve(var_exprKeyName_identifier, var_literal6);

		setDefaultStringIfNull7.setRuleName("SymmetricEncryptionTask");
		setDefaultStringIfNull7.solve(var_methodEncryption_type, var_literal3);

		setDefaultStringIfNull8.setRuleName("SymmetricEncryptionTask");
		setDefaultStringIfNull8.solve(var_exprKeyName_index, var_literal1);

		setDefaultStringIfNull9.setRuleName("SymmetricEncryptionTask");
		setDefaultStringIfNull9.solve(var_exprDataName_identifier, var_literal10);

		setDefaultStringIfNull10.setRuleName("SymmetricEncryptionTask");
		setDefaultStringIfNull10.solve(var_methodEncryption_modifier, var_literal5);

		setDefaultStringIfNull11.setRuleName("SymmetricEncryptionTask");
		setDefaultStringIfNull11.solve(var_methodPerformEncryption_modifier, var_literal9);

		setDefaultStringIfNull12.setRuleName("SymmetricEncryptionTask");
		setDefaultStringIfNull12.solve(var_methodEncryption_name, var_literal8);

		setDefaultStringIfNull13.setRuleName("SymmetricEncryptionTask");
		setDefaultStringIfNull13.solve(var_methodPerformEncryption_body, var_literal13);

		setDefaultStringIfNull14.setRuleName("SymmetricEncryptionTask");
		setDefaultStringIfNull14.solve(var_methodPerformEncryption_index, var_literal11);

		setDefaultStringIfNull15.setRuleName("SymmetricEncryptionTask");
		setDefaultStringIfNull15.solve(var_jcu_name, var_literal12);

		setDefaultStringIfNull16.setRuleName("SymmetricEncryptionTask");
		setDefaultStringIfNull16.solve(var_exprDataName_index, var_literal11);
	...
	public AttributeConstraintsRuleResult checkAttributes_BWD(TripleMatch __tripleMatch) {
		...
		setDefaultStringIfNull0.setRuleName("SymmetricEncryptionTask");
		setDefaultStringIfNull0.solve(var_methodEncryption_throws, var_literal0);

		setDefaultStringIfNull1.setRuleName("SymmetricEncryptionTask");
		setDefaultStringIfNull1.solve(var_methodEncryption_index, var_literal1);

		setDefaultStringIfNull2.setRuleName("SymmetricEncryptionTask");
		setDefaultStringIfNull2.solve(var_methodPerformEncryption_throws, var_literal0);

		setDefaultStringIfNull3.setRuleName("SymmetricEncryptionTask");
		setDefaultStringIfNull3.solve(var_exprNameModePadding_index, var_literal2);

		setDefaultStringIfNull4.setRuleName("SymmetricEncryptionTask");
		setDefaultStringIfNull4.solve(var_methodPerformEncryption_parameters, var_literal4);

		setDefaultStringIfNull5.setRuleName("SymmetricEncryptionTask");
		setDefaultStringIfNull5.solve(var_exprKeyName_identifier, var_literal6);

		setDefaultStringIfNull6.setRuleName("SymmetricEncryptionTask");
		setDefaultStringIfNull6.solve(var_methodEncryption_type, var_literal3);

		setDefaultStringIfNull7.setRuleName("SymmetricEncryptionTask");
		setDefaultStringIfNull7.solve(var_exprKeyName_index, var_literal1);

		setDefaultStringIfNull8.setRuleName("SymmetricEncryptionTask");
		setDefaultStringIfNull8.solve(var_exprDataName_identifier, var_literal10);

		setDefaultStringIfNull9.setRuleName("SymmetricEncryptionTask");
		setDefaultStringIfNull9.solve(var_methodEncryption_modifier, var_literal5);

		setDefaultStringIfNull10.setRuleName("SymmetricEncryptionTask");
		setDefaultStringIfNull10.solve(var_methodPerformEncryption_modifier, var_literal9);

		setDefaultStringIfNull11.setRuleName("SymmetricEncryptionTask");
		setDefaultStringIfNull11.solve(var_methodEncryption_name, var_literal8);

		setDefaultStringIfNull12.setRuleName("SymmetricEncryptionTask");
		setDefaultStringIfNull12.solve(var_methodPerformEncryption_body, var_literal13);

		setDefaultStringIfNull13.setRuleName("SymmetricEncryptionTask");
		setDefaultStringIfNull13.solve(var_methodPerformEncryption_index, var_literal11);

		setDefaultStringIfNull14.setRuleName("SymmetricEncryptionTask");
		setDefaultStringIfNull14.solve(var_jcu_name, var_literal12);

		setDefaultStringIfNull15.setRuleName("SymmetricEncryptionTask");
		setDefaultStringIfNull15.solve(var_exprDataName_index, var_literal11);

		setDefaultStringIfNull16.setRuleName("SymmetricEncryptionTask");
		setDefaultStringIfNull16.solve(var_task_package, var_literal7);
	...
	public IsApplicableRuleResult isApplicable_CC(Match sourceMatch, Match targetMatch) {
		...
		JavaLiteral exprNameModePadding = (JavaLiteral) result2_bindingAndBlack[0];
		JavaMethodInvocation exprRetPerformEncryption = (JavaMethodInvocation) result2_bindingAndBlack[1];
		JavaVariableDeclaration keyEncryption = (JavaVariableDeclaration) result2_bindingAndBlack[2];
		JavaName exprDataName = (JavaName) result2_bindingAndBlack[3];
		JavaPackage javaPackage = (JavaPackage) result2_bindingAndBlack[4];
		JavaVariableDeclaration dataEncryption = (JavaVariableDeclaration) result2_bindingAndBlack[5];
		SymmetricBlockCipher sbc = (SymmetricBlockCipher) result2_bindingAndBlack[6];
		JavaName exprKeyName = (JavaName) result2_bindingAndBlack[7];
		JavaWorkflowMethod methodEncryption = (JavaWorkflowMethod) result2_bindingAndBlack[8];
		JavaCompilationUnit jcu = (JavaCompilationUnit) result2_bindingAndBlack[9];
		JavaOpaqueMethod methodPerformEncryption = (JavaOpaqueMethod) result2_bindingAndBlack[10];
		Task task = (Task) result2_bindingAndBlack[11];
		JavaStatement statRetPerformEncryption = (JavaStatement) result2_bindingAndBlack[12];

		Object[] result3_bindingAndBlack = SymmetricEncryptionTaskImpl
				.pattern_SymmetricEncryptionTask_24_3_solvecsp_bindingAndBlackFBBBBBBBBBBBBBBBB(this,
						exprNameModePadding, exprRetPerformEncryption, keyEncryption, exprDataName, javaPackage,
						dataEncryption, sbc, exprKeyName, methodEncryption, jcu, methodPerformEncryption, task,
						statRetPerformEncryption, sourceMatch, targetMatch);
		if (result3_bindingAndBlack == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
					+ "[exprNameModePadding] = " + exprNameModePadding + ", " + "[exprRetPerformEncryption] = "
					+ exprRetPerformEncryption + ", " + "[keyEncryption] = " + keyEncryption + ", "
					+ "[exprDataName] = " + exprDataName + ", " + "[javaPackage] = " + javaPackage + ", "
					+ "[dataEncryption] = " + dataEncryption + ", " + "[sbc] = " + sbc + ", " + "[exprKeyName] = "
					+ exprKeyName + ", " + "[methodEncryption] = " + methodEncryption + ", " + "[jcu] = " + jcu + ", "
					+ "[methodPerformEncryption] = " + methodPerformEncryption + ", " + "[task] = " + task + ", "
					+ "[statRetPerformEncryption] = " + statRetPerformEncryption + ", " + "[sourceMatch] = "
		...
		if (SymmetricEncryptionTaskImpl.pattern_SymmetricEncryptionTask_24_4_checkCSP_expressionFB(csp)) {
			...
			for (Object[] result5_black : SymmetricEncryptionTaskImpl
				...
				Object[] result6_black = SymmetricEncryptionTaskImpl
						.pattern_SymmetricEncryptionTask_24_6_createcorrespondence_blackBBBBBBBBBBBBBB(
								exprNameModePadding, exprRetPerformEncryption, keyEncryption, exprDataName, javaPackage,
								dataEncryption, sbc, exprKeyName, methodEncryption, jcu, methodPerformEncryption, task,
								statRetPerformEncryption, ccMatch);
				if (result6_black == null) {
					throw new RuntimeException("Pattern matching failed." + " Variables: " + "[exprNameModePadding] = "
							+ exprNameModePadding + ", " + "[exprRetPerformEncryption] = " + exprRetPerformEncryption
							+ ", " + "[keyEncryption] = " + keyEncryption + ", " + "[exprDataName] = " + exprDataName
							+ ", " + "[javaPackage] = " + javaPackage + ", " + "[dataEncryption] = " + dataEncryption
							+ ", " + "[sbc] = " + sbc + ", " + "[exprKeyName] = " + exprKeyName + ", "
							+ "[methodEncryption] = " + methodEncryption + ", " + "[jcu] = " + jcu + ", "
							+ "[methodPerformEncryption] = " + methodPerformEncryption + ", " + "[task] = " + task
							+ ", " + "[statRetPerformEncryption] = " + statRetPerformEncryption + ", " + "[ccMatch] = "
							+ ccMatch + ".");
				}
				SymmetricEncryptionTaskImpl.pattern_SymmetricEncryptionTask_24_6_createcorrespondence_greenBFBFBBB(
						javaPackage, sbc, jcu, task, ccMatch);
	 ...
	 * @generated
	 */
	public CSP isApplicable_solveCsp_CC(JavaLiteral exprNameModePadding, JavaMethodInvocation exprRetPerformEncryption,
			...
			JavaWorkflowMethod methodEncryption, JavaCompilationUnit jcu, JavaOpaqueMethod methodPerformEncryption,
			Task task, JavaStatement statRetPerformEncryption, Match sourceMatch, Match targetMatch) {// Create CSP
		CSP csp = CspFactory.eINSTANCE.createCSP();
	 ...
	 * @generated
	 */
	public boolean checkDEC_BWD(JavaLiteral exprNameModePadding, JavaMethodInvocation exprRetPerformEncryption,
			JavaVariableDeclaration keyEncryption, JavaName exprDataName, JavaPackage javaPackage,
		...
		Object[] result1_black = SymmetricEncryptionTaskImpl
				.pattern_SymmetricEncryptionTask_28_1_matchtggpattern_blackBBBBBBBBBBB(exprNameModePadding,
						exprRetPerformEncryption, keyEncryption, exprDataName, javaPackage, dataEncryption, exprKeyName,
						methodEncryption, jcu, methodPerformEncryption, statRetPerformEncryption);
		if (result1_black != null) {
			SymmetricEncryptionTaskImpl.pattern_SymmetricEncryptionTask_28_1_matchtggpattern_greenBBBBB(
					exprRetPerformEncryption, keyEncryption, dataEncryption, methodPerformEncryption,
					statRetPerformEncryption);
	...
	public ModelgeneratorRuleResult generateModel(RuleEntryContainer ruleEntryContainer) {
		...
		if (result2_black != null) {
			...
			if (SymmetricEncryptionTaskImpl.pattern_SymmetricEncryptionTask_29_4_checkCSP_expressionFBB(this, csp)) {
				...
				//nothing JavaLiteral exprNameModePadding = (JavaLiteral) result6_green[0];
				//nothing JavaMethodInvocation exprRetPerformEncryption = (JavaMethodInvocation) result6_green[1];
				//nothing JavaVariableDeclaration keyEncryption = (JavaVariableDeclaration) result6_green[2];
				//nothing JavaName exprDataName = (JavaName) result6_green[3];
				//nothing JavaPackage javaPackage = (JavaPackage) result6_green[4];
				//nothing SymmetricBlockCipherToJcu sbc2Jcu = (SymmetricBlockCipherToJcu) result6_green[5];
				//nothing JavaVariableDeclaration dataEncryption = (JavaVariableDeclaration) result6_green[6];
				//nothing SymmetricBlockCipher sbc = (SymmetricBlockCipher) result6_green[7];
				//nothing JavaName exprKeyName = (JavaName) result6_green[8];
				...
				//nothing JavaOpaqueMethod methodPerformEncryption = (JavaOpaqueMethod) result6_green[12];
				//nothing Task task = (Task) result6_green[13];
				//nothing JavaStatement statRetPerformEncryption = (JavaStatement) result6_green[14];
	...
	public CSP generateModel_solveCsp_BWD(IsApplicableMatch isApplicableMatch, ModelgeneratorRuleResult ruleResult) {// Create CSP
		...
		literal8.setType("");
		Variable literal9 = CSPFactoryHelper.eINSTANCE.createVariable("literal9", true, csp);
		literal9.setValue("crypto");
		literal9.setType("");
		Variable literal10 = CSPFactoryHelper.eINSTANCE.createVariable("literal10", true, csp);
		literal10.setValue("encrypt");
		literal10.setType("");
		Variable literal11 = CSPFactoryHelper.eINSTANCE.createVariable("literal11", true, csp);
		literal11.setValue(
				"{\n  byte[] ivb=new byte[16];\n  SecureRandom.getInstanceStrong().nextBytes(ivb);\n  IvParameterSpec iv=new IvParameterSpec(ivb);\n  Cipher c=Cipher.getInstance(encryptPassingArgument);\n  c.init(Cipher.ENCRYPT_MODE,key,iv);\n  byte[] res=c.doFinal(data);\n  byte[] ret=new byte[res.length + ivb.length];\n  System.arraycopy(ivb,0,ret,0,ivb.length);\n  System.arraycopy(res,0,ret,ivb.length,ret.length);\n  return ret;\n}\n");
		...
		setDefaultStringIfNull_9.solve(var_methodPerformEncryption_modifier, literal8);
		setDefaultStringIfNull_10.setRuleName("NoRuleName");
		setDefaultStringIfNull_10.solve(var_task_package, literal9);
		setDefaultStringIfNull_11.setRuleName("NoRuleName");
		setDefaultStringIfNull_11.solve(var_methodEncryption_name, literal10);
		setDefaultStringIfNull_12.setRuleName("NoRuleName");
		setDefaultStringIfNull_12.solve(var_methodPerformEncryption_body, literal11);
		setDefaultStringIfNull_13.setRuleName("NoRuleName");
		setDefaultStringIfNull_13.solve(var_methodPerformEncryption_index, literal12);
		setDefaultStringIfNull_14.setRuleName("NoRuleName");
		setDefaultStringIfNull_14.solve(var_jcu_name, literal13);
		setDefaultStringIfNull_15.setRuleName("NoRuleName");
		setDefaultStringIfNull_15.solve(var_exprDataName_index, literal12);
		eq.setRuleName("NoRuleName");
		eq.solve(var_task_package, var_javaPackage_name);
		nameModePadding.setRuleName("NoRuleName");
		nameModePadding.solve(var_sbc_name, var_sbc_mode, var_sbc_padding, var_exprNameModePadding_value);
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		...
		case RulesPackage.SYMMETRIC_ENCRYPTION_TASK___IS_APPROPRIATE_BWD__MATCH_JAVALITERAL_JAVAMETHODINVOCATION_JAVAVARIABLEDECLARATION_JAVANAME_JAVAPACKAGE_JAVAVARIABLEDECLARATION_JAVANAME_JAVAWORKFLOWMETHOD_JAVACOMPILATIONUNIT_JAVAOPAQUEMETHOD_JAVASTATEMENT:
			return isAppropriate_BWD((Match) arguments.get(0), (JavaLiteral) arguments.get(1),
					...
					(JavaName) arguments.get(4), (JavaPackage) arguments.get(5),
					(JavaVariableDeclaration) arguments.get(6), (JavaName) arguments.get(7),
					(JavaWorkflowMethod) arguments.get(8), (JavaCompilationUnit) arguments.get(9),
					(JavaOpaqueMethod) arguments.get(10), (JavaStatement) arguments.get(11));
		...
		case RulesPackage.SYMMETRIC_ENCRYPTION_TASK___REGISTER_OBJECTS_TO_MATCH_BWD__MATCH_JAVALITERAL_JAVAMETHODINVOCATION_JAVAVARIABLEDECLARATION_JAVANAME_JAVAPACKAGE_JAVAVARIABLEDECLARATION_JAVANAME_JAVAWORKFLOWMETHOD_JAVACOMPILATIONUNIT_JAVAOPAQUEMETHOD_JAVASTATEMENT:
			registerObjectsToMatch_BWD((Match) arguments.get(0), (JavaLiteral) arguments.get(1),
					...
					(JavaOpaqueMethod) arguments.get(10), (JavaStatement) arguments.get(11));
			return null;
		case RulesPackage.SYMMETRIC_ENCRYPTION_TASK___IS_APPROPRIATE_SOLVE_CSP_BWD__MATCH_JAVALITERAL_JAVAMETHODINVOCATION_JAVAVARIABLEDECLARATION_JAVANAME_JAVAPACKAGE_JAVAVARIABLEDECLARATION_JAVANAME_JAVAWORKFLOWMETHOD_JAVACOMPILATIONUNIT_JAVAOPAQUEMETHOD_JAVASTATEMENT:
		...
		case RulesPackage.SYMMETRIC_ENCRYPTION_TASK___IS_APPLICABLE_SOLVE_CSP_BWD__ISAPPLICABLEMATCH_JAVALITERAL_JAVAMETHODINVOCATION_JAVAVARIABLEDECLARATION_JAVANAME_JAVAPACKAGE_JAVAVARIABLEDECLARATION_JAVANAME_JAVAWORKFLOWMETHOD_JAVACOMPILATIONUNIT_JAVAOPAQUEMETHOD_JAVASTATEMENT:
		...
		case RulesPackage.SYMMETRIC_ENCRYPTION_TASK___IS_APPLICABLE_SOLVE_CSP_CC__JAVALITERAL_JAVAMETHODINVOCATION_JAVAVARIABLEDECLARATION_JAVANAME_JAVAPACKAGE_JAVAVARIABLEDECLARATION_SYMMETRICBLOCKCIPHER_JAVANAME_JAVAWORKFLOWMETHOD_JAVACOMPILATIONUNIT_JAVAOPAQUEMETHOD_TASK_JAVASTATEMENT_MATCH_MATCH:
			return isApplicable_solveCsp_CC((JavaLiteral) arguments.get(0), (JavaMethodInvocation) arguments.get(1),
					(JavaVariableDeclaration) arguments.get(2), (JavaName) arguments.get(3),
					(JavaPackage) arguments.get(4), (JavaVariableDeclaration) arguments.get(5),
					(SymmetricBlockCipher) arguments.get(6), (JavaName) arguments.get(7),
					(JavaWorkflowMethod) arguments.get(8), (JavaCompilationUnit) arguments.get(9),
					(JavaOpaqueMethod) arguments.get(10), (Task) arguments.get(11), (JavaStatement) arguments.get(12),
		...
		case RulesPackage.SYMMETRIC_ENCRYPTION_TASK___CHECK_DEC_BWD__JAVALITERAL_JAVAMETHODINVOCATION_JAVAVARIABLEDECLARATION_JAVANAME_JAVAPACKAGE_JAVAVARIABLEDECLARATION_JAVANAME_JAVAWORKFLOWMETHOD_JAVACOMPILATIONUNIT_JAVAOPAQUEMETHOD_JAVASTATEMENT:
			return checkDEC_BWD((JavaLiteral) arguments.get(0), (JavaMethodInvocation) arguments.get(1),
					(JavaVariableDeclaration) arguments.get(2), (JavaName) arguments.get(3),
					(JavaPackage) arguments.get(4), (JavaVariableDeclaration) arguments.get(5),
					(JavaName) arguments.get(6), (JavaWorkflowMethod) arguments.get(7),
					(JavaCompilationUnit) arguments.get(8), (JavaOpaqueMethod) arguments.get(9),
					(JavaStatement) arguments.get(10));
	...
	public static final Object[] pattern_SymmetricEncryptionTask_1_1_performtransformation_greenFFFFFFFBFFFFFBFB(
		...
		Object _localVariable_0 = csp.getValue("exprNameModePadding", "index");
		Object _localVariable_1 = csp.getValue("exprNameModePadding", "value");
		...
		Object _localVariable_2 = csp.getValue("exprDataName", "identifier");
		Object _localVariable_3 = csp.getValue("exprDataName", "index");
		Object _localVariable_4 = csp.getValue("javaPackage", "name");
		...
		Object _localVariable_5 = csp.getValue("exprKeyName", "identifier");
		Object _localVariable_6 = csp.getValue("exprKeyName", "index");
		Object _localVariable_7 = csp.getValue("methodEncryption", "throws");
		Object _localVariable_8 = csp.getValue("methodEncryption", "index");
		Object _localVariable_9 = csp.getValue("methodEncryption", "type");
		Object _localVariable_10 = csp.getValue("methodEncryption", "modifier");
		Object _localVariable_11 = csp.getValue("methodEncryption", "name");
		...
		Object _localVariable_13 = csp.getValue("methodPerformEncryption", "throws");
		...
		Object _localVariable_16 = csp.getValue("methodPerformEncryption", "body");
		...
		int exprNameModePadding_index_prime = (int) _localVariable_0;
		String exprNameModePadding_value_prime = (String) _localVariable_1;
		...
		String exprDataName_identifier_prime = (String) _localVariable_2;
		int exprDataName_index_prime = (int) _localVariable_3;
		String javaPackage_name_prime = (String) _localVariable_4;
		...
		String exprKeyName_identifier_prime = (String) _localVariable_5;
		int exprKeyName_index_prime = (int) _localVariable_6;
		String methodEncryption_throws_prime = (String) _localVariable_7;
		int methodEncryption_index_prime = (int) _localVariable_8;
		String methodEncryption_type_prime = (String) _localVariable_9;
		String methodEncryption_modifier_prime = (String) _localVariable_10;
		String methodEncryption_name_prime = (String) _localVariable_11;
		...
		String methodPerformEncryption_throws_prime = (String) _localVariable_13;
		...
		String methodPerformEncryption_body_prime = (String) _localVariable_16;
		...
		return new Object[] { exprNameModePadding, exprRetPerformEncryption, keyEncryption, exprDataName, javaPackage,
				sbc2Jcu, dataEncryption, sbc, exprKeyName, methodEncryption, t2c, jcu, methodPerformEncryption, task,
				statRetPerformEncryption, csp };
	}

	public static final Object[] pattern_SymmetricEncryptionTask_1_2_collecttranslatedelements_blackBBBBBBBBBBBBBBB(
			JavaLiteral exprNameModePadding, JavaMethodInvocation exprRetPerformEncryption,
			JavaVariableDeclaration keyEncryption, JavaName exprDataName, JavaPackage javaPackage,
			SymmetricBlockCipherToJcu sbc2Jcu, JavaVariableDeclaration dataEncryption, SymmetricBlockCipher sbc,
			JavaName exprKeyName, JavaWorkflowMethod methodEncryption, TaskToJavaPackage t2c, JavaCompilationUnit jcu,
			JavaOpaqueMethod methodPerformEncryption, Task task, JavaStatement statRetPerformEncryption) {
		if (!exprDataName.equals(exprKeyName)) {
			if (!dataEncryption.equals(keyEncryption)) {
				return new Object[] { exprNameModePadding, exprRetPerformEncryption, keyEncryption, exprDataName,
						javaPackage, sbc2Jcu, dataEncryption, sbc, exprKeyName, methodEncryption, t2c, jcu,
						methodPerformEncryption, task, statRetPerformEncryption };
			}
		}
	...
	public static final Object[] pattern_SymmetricEncryptionTask_1_2_collecttranslatedelements_greenFBBBBBBBBBBBBBBB(
		...
		return new Object[] { ruleresult, exprNameModePadding, exprRetPerformEncryption, keyEncryption, exprDataName,
				javaPackage, sbc2Jcu, dataEncryption, sbc, exprKeyName, methodEncryption, t2c, jcu,
				methodPerformEncryption, task, statRetPerformEncryption };
	}

	public static final Object[] pattern_SymmetricEncryptionTask_1_3_bookkeepingforedges_blackBBBBBBBBBBBBBBBB(
			PerformRuleResult ruleresult, EObject exprNameModePadding, EObject exprRetPerformEncryption,
			EObject keyEncryption, EObject exprDataName, EObject javaPackage, EObject sbc2Jcu, EObject dataEncryption,
			EObject sbc, EObject exprKeyName, EObject methodEncryption, EObject t2c, EObject jcu,
			EObject methodPerformEncryption, EObject task, EObject statRetPerformEncryption) {
		if (!exprNameModePadding.equals(exprRetPerformEncryption)) {
			if (!exprNameModePadding.equals(keyEncryption)) {
				if (!exprNameModePadding.equals(javaPackage)) {
					if (!exprNameModePadding.equals(sbc2Jcu)) {
						if (!exprNameModePadding.equals(sbc)) {
							if (!exprNameModePadding.equals(methodEncryption)) {
								if (!exprNameModePadding.equals(t2c)) {
									if (!exprNameModePadding.equals(jcu)) {
										if (!exprNameModePadding.equals(methodPerformEncryption)) {
											if (!exprNameModePadding.equals(task)) {
												if (!exprNameModePadding.equals(statRetPerformEncryption)) {
	...
	public static final Object[] pattern_SymmetricEncryptionTask_1_3_bookkeepingforedges_greenBBBBBBBBBBBBBBBBFFFFFFFFFFFFFFF(
		...
		return new Object[] { ruleresult, exprNameModePadding, exprRetPerformEncryption, keyEncryption, exprDataName,
				...
				exprRetPerformEncryption__exprKeyName____arguments,
				exprRetPerformEncryption__exprNameModePadding____arguments,
				exprRetPerformEncryption__exprDataName____arguments, javaPackage__jcu____cunits,
				t2c__javaPackage____target, sbc2Jcu__jcu____target, jcu__methodPerformEncryption____methods,
				sbc2Jcu__sbc____source, methodEncryption__dataEncryption____params, jcu__methodEncryption____methods,
				methodEncryption__statRetPerformEncryption____statements, t2c__task____source, task__sbc____algorithms,
	...
	public static final void pattern_SymmetricEncryptionTask_1_5_registerobjects_expressionBBBBBBBBBBBBBBBBB(
			SymmetricEncryptionTask _this, PerformRuleResult ruleresult, EObject exprNameModePadding,
			EObject exprRetPerformEncryption, EObject keyEncryption, EObject exprDataName, EObject javaPackage,
			EObject sbc2Jcu, EObject dataEncryption, EObject sbc, EObject exprKeyName, EObject methodEncryption,
			EObject t2c, EObject jcu, EObject methodPerformEncryption, EObject task, EObject statRetPerformEncryption) {
		_this.registerObjects_FWD(ruleresult, exprNameModePadding, exprRetPerformEncryption, keyEncryption,
				exprDataName, javaPackage, sbc2Jcu, dataEncryption, sbc, exprKeyName, methodEncryption, t2c, jcu,
				methodPerformEncryption, task, statRetPerformEncryption);
	...
	public static final Object[] pattern_SymmetricEncryptionTask_10_1_initialbindings_blackBBBBBBBBBBBBB(
			SymmetricEncryptionTask _this, Match match, JavaLiteral exprNameModePadding,
			JavaMethodInvocation exprRetPerformEncryption, JavaVariableDeclaration keyEncryption, JavaName exprDataName,
			JavaPackage javaPackage, JavaVariableDeclaration dataEncryption, JavaName exprKeyName,
			JavaWorkflowMethod methodEncryption, JavaCompilationUnit jcu, JavaOpaqueMethod methodPerformEncryption,
			JavaStatement statRetPerformEncryption) {
		if (!exprDataName.equals(exprKeyName)) {
			if (!dataEncryption.equals(keyEncryption)) {
				return new Object[] { _this, match, exprNameModePadding, exprRetPerformEncryption, keyEncryption,
						exprDataName, javaPackage, dataEncryption, exprKeyName, methodEncryption, jcu,
						methodPerformEncryption, statRetPerformEncryption };
			}
		}
	...
	public static final Object[] pattern_SymmetricEncryptionTask_10_2_SolveCSP_bindingFBBBBBBBBBBBBB(
			...
			JavaWorkflowMethod methodEncryption, JavaCompilationUnit jcu, JavaOpaqueMethod methodPerformEncryption,
			JavaStatement statRetPerformEncryption) {
		CSP _localVariable_0 = _this.isAppropriate_solveCsp_BWD(match, exprNameModePadding, exprRetPerformEncryption,
				keyEncryption, exprDataName, javaPackage, dataEncryption, exprKeyName, methodEncryption, jcu,
				methodPerformEncryption, statRetPerformEncryption);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, match, exprNameModePadding, exprRetPerformEncryption, keyEncryption,
					exprDataName, javaPackage, dataEncryption, exprKeyName, methodEncryption, jcu,
					methodPerformEncryption, statRetPerformEncryption };
		}
		return null;
	...
	public static final Object[] pattern_SymmetricEncryptionTask_10_2_SolveCSP_bindingAndBlackFBBBBBBBBBBBBB(
		...
		Object[] result_pattern_SymmetricEncryptionTask_10_2_SolveCSP_binding = pattern_SymmetricEncryptionTask_10_2_SolveCSP_bindingFBBBBBBBBBBBBB(
				_this, match, exprNameModePadding, exprRetPerformEncryption, keyEncryption, exprDataName, javaPackage,
				dataEncryption, exprKeyName, methodEncryption, jcu, methodPerformEncryption, statRetPerformEncryption);
	...
	public static final Object[] pattern_SymmetricEncryptionTask_10_4_collectelementstobetranslated_blackBBBBBBBBBBBB(
			Match match, JavaLiteral exprNameModePadding, JavaMethodInvocation exprRetPerformEncryption,
			JavaVariableDeclaration keyEncryption, JavaName exprDataName, JavaPackage javaPackage,
			JavaVariableDeclaration dataEncryption, JavaName exprKeyName, JavaWorkflowMethod methodEncryption,
			JavaCompilationUnit jcu, JavaOpaqueMethod methodPerformEncryption, JavaStatement statRetPerformEncryption) {
		if (!exprDataName.equals(exprKeyName)) {
			if (!dataEncryption.equals(keyEncryption)) {
				return new Object[] { match, exprNameModePadding, exprRetPerformEncryption, keyEncryption, exprDataName,
						javaPackage, dataEncryption, exprKeyName, methodEncryption, jcu, methodPerformEncryption,
						statRetPerformEncryption };
			}
		}
	...
	public static final Object[] pattern_SymmetricEncryptionTask_10_4_collectelementstobetranslated_greenBBBBBBBBBBBBFFFFFFFFFF(
		...
		return new Object[] { match, exprNameModePadding, exprRetPerformEncryption, keyEncryption, exprDataName,
				javaPackage, dataEncryption, exprKeyName, methodEncryption, jcu, methodPerformEncryption,
				statRetPerformEncryption, exprRetPerformEncryption__exprKeyName____arguments,
				exprRetPerformEncryption__exprNameModePadding____arguments,
				exprRetPerformEncryption__exprDataName____arguments, javaPackage__jcu____cunits,
				jcu__methodPerformEncryption____methods, methodEncryption__dataEncryption____params,
				jcu__methodEncryption____methods, methodEncryption__statRetPerformEncryption____statements,
				methodEncryption__keyEncryption____params, statRetPerformEncryption__exprRetPerformEncryption____expr };
	}
	...
	public static final void pattern_SymmetricEncryptionTask_10_6_registerobjectstomatch_expressionBBBBBBBBBBBBB(
			...
			JavaWorkflowMethod methodEncryption, JavaCompilationUnit jcu, JavaOpaqueMethod methodPerformEncryption,
			JavaStatement statRetPerformEncryption) {
		_this.registerObjectsToMatch_BWD(match, exprNameModePadding, exprRetPerformEncryption, keyEncryption,
				exprDataName, javaPackage, dataEncryption, exprKeyName, methodEncryption, jcu, methodPerformEncryption,
				statRetPerformEncryption);
	...
	public static final Object[] pattern_SymmetricEncryptionTask_11_1_performtransformation_bindingFFFFFFFFFFFB(
			IsApplicableMatch isApplicableMatch) {
		EObject _localVariable_0 = isApplicableMatch.getObject("exprNameModePadding");
		...
		EObject _localVariable_4 = isApplicableMatch.getObject("javaPackage");
		...
		EObject _localVariable_9 = isApplicableMatch.getObject("methodPerformEncryption");
		EObject _localVariable_10 = isApplicableMatch.getObject("statRetPerformEncryption");
		EObject tmpExprNameModePadding = _localVariable_0;
		...
		EObject tmpMethodPerformEncryption = _localVariable_9;
		EObject tmpStatRetPerformEncryption = _localVariable_10;
										...
										if (tmpJcu instanceof JavaCompilationUnit) {
											...
											if (tmpMethodPerformEncryption instanceof JavaOpaqueMethod) {
												...
												if (tmpStatRetPerformEncryption instanceof JavaStatement) {
													...
													return new Object[] { exprNameModePadding, exprRetPerformEncryption,
															keyEncryption, exprDataName, javaPackage, dataEncryption,
															exprKeyName, methodEncryption, jcu, methodPerformEncryption,
															statRetPerformEncryption, isApplicableMatch };
												}
											}
										}
									}
		...
		if (!exprDataName.equals(exprKeyName)) {
			if (!dataEncryption.equals(keyEncryption)) {
				for (EObject tmpCsp : isApplicableMatch.getAttributeInfo()) {
					if (tmpCsp instanceof CSP) {
						CSP csp = (CSP) tmpCsp;
						return new Object[] { exprNameModePadding, exprRetPerformEncryption, keyEncryption,
								exprDataName, javaPackage, dataEncryption, exprKeyName, methodEncryption, jcu,
								methodPerformEncryption, statRetPerformEncryption, csp, _this, isApplicableMatch };
					}
				}
			}
		}
	...
	public static final Object[] pattern_SymmetricEncryptionTask_11_1_performtransformation_bindingAndBlackFFFFFFFFFFFFBB(
		...
		if (result_pattern_SymmetricEncryptionTask_11_1_performtransformation_binding != null) {
			JavaLiteral exprNameModePadding = (JavaLiteral) result_pattern_SymmetricEncryptionTask_11_1_performtransformation_binding[0];
			...
			JavaPackage javaPackage = (JavaPackage) result_pattern_SymmetricEncryptionTask_11_1_performtransformation_binding[4];
			...
			JavaOpaqueMethod methodPerformEncryption = (JavaOpaqueMethod) result_pattern_SymmetricEncryptionTask_11_1_performtransformation_binding[9];
			JavaStatement statRetPerformEncryption = (JavaStatement) result_pattern_SymmetricEncryptionTask_11_1_performtransformation_binding[10];
			...
			Object[] result_pattern_SymmetricEncryptionTask_11_1_performtransformation_black = pattern_SymmetricEncryptionTask_11_1_performtransformation_blackBBBBBBBBBBBFBB(
					exprNameModePadding, exprRetPerformEncryption, keyEncryption, exprDataName, javaPackage,
					dataEncryption, exprKeyName, methodEncryption, jcu, methodPerformEncryption,
					statRetPerformEncryption, _this, isApplicableMatch);
			if (result_pattern_SymmetricEncryptionTask_11_1_performtransformation_black != null) {
				...
				return new Object[] { exprNameModePadding, exprRetPerformEncryption, keyEncryption, exprDataName,
						javaPackage, dataEncryption, exprKeyName, methodEncryption, jcu, methodPerformEncryption,
						statRetPerformEncryption, csp, _this, isApplicableMatch };
			}
		}
		return null;
	}
	...
	public static final Object[] pattern_SymmetricEncryptionTask_11_1_performtransformation_greenBFFFBFB(
		...
		return new Object[] { javaPackage, sbc2Jcu, sbc, t2c, jcu, task, csp };
	}
	...
	public static final void pattern_SymmetricEncryptionTask_11_5_registerobjects_expressionBBBBBBBBBBBBBBBBB(
			...
			EObject sbc2Jcu, EObject dataEncryption, EObject sbc, EObject exprKeyName, EObject methodEncryption,
			EObject t2c, EObject jcu, EObject methodPerformEncryption, EObject task, EObject statRetPerformEncryption) {
		_this.registerObjects_BWD(ruleresult, exprNameModePadding, exprRetPerformEncryption, keyEncryption,
				exprDataName, javaPackage, sbc2Jcu, dataEncryption, sbc, exprKeyName, methodEncryption, t2c, jcu,
				methodPerformEncryption, task, statRetPerformEncryption);
	...
	public static final Object[] pattern_SymmetricEncryptionTask_12_2_corematch_bindingFFFFFFFFFFFB(Match match) {
		EObject _localVariable_0 = match.getObject("exprNameModePadding");
		...
		EObject _localVariable_4 = match.getObject("javaPackage");
		...
		EObject _localVariable_9 = match.getObject("methodPerformEncryption");
		EObject _localVariable_10 = match.getObject("statRetPerformEncryption");
		EObject tmpExprNameModePadding = _localVariable_0;
		EObject tmpExprRetPerformEncryption = _localVariable_1;
		EObject tmpKeyEncryption = _localVariable_2;
		EObject tmpExprDataName = _localVariable_3;
											...
											if (tmpMethodPerformEncryption instanceof JavaOpaqueMethod) {
												...
												if (tmpStatRetPerformEncryption instanceof JavaStatement) {
													...
													return new Object[] { exprNameModePadding, exprRetPerformEncryption,
															keyEncryption, exprDataName, javaPackage, dataEncryption,
															exprKeyName, methodEncryption, jcu, methodPerformEncryption,
															statRetPerformEncryption, match };
												}
											}
										}
									}
											...
											if (methodPerformEncryption_type.equals("byte[] ")) {
												...
												if (methodPerformEncryption_name.equals("performEncryption")) {
													...
													if (Boolean.valueOf(statRetPerformEncryption_return)
														...
														_result.add(new Object[] { exprNameModePadding,
																exprRetPerformEncryption, keyEncryption, exprDataName,
																javaPackage, dataEncryption, exprKeyName,
																methodEncryption, jcu, methodPerformEncryption,
																statRetPerformEncryption, match });
													}
										...
										if (jcu.getMethods().contains(methodEncryption)) {
											if (methodEncryption.getStatements().contains(statRetPerformEncryption)) {
												if (methodEncryption.getParams().contains(keyEncryption)) {
													if (exprRetPerformEncryption
															.equals(statRetPerformEncryption.getExpr())) {
	...
	public static final Object[] pattern_SymmetricEncryptionTask_12_3_findcontext_greenBBBBBBBBBBBFFFFFFFFFFF(
		...
		return new Object[] { exprNameModePadding, exprRetPerformEncryption, keyEncryption, exprDataName, javaPackage,
				dataEncryption, exprKeyName, methodEncryption, jcu, methodPerformEncryption, statRetPerformEncryption,
				isApplicableMatch, exprRetPerformEncryption__exprKeyName____arguments,
				exprRetPerformEncryption__exprNameModePadding____arguments,
				exprRetPerformEncryption__exprDataName____arguments, javaPackage__jcu____cunits,
				jcu__methodPerformEncryption____methods, methodEncryption__dataEncryption____params,
				jcu__methodEncryption____methods, methodEncryption__statRetPerformEncryption____statements,
	...
	public static final Object[] pattern_SymmetricEncryptionTask_12_4_solveCSP_bindingFBBBBBBBBBBBBB(
			SymmetricEncryptionTask _this, IsApplicableMatch isApplicableMatch, JavaLiteral exprNameModePadding,
			JavaMethodInvocation exprRetPerformEncryption, JavaVariableDeclaration keyEncryption, JavaName exprDataName,
			JavaPackage javaPackage, JavaVariableDeclaration dataEncryption, JavaName exprKeyName,
			JavaWorkflowMethod methodEncryption, JavaCompilationUnit jcu, JavaOpaqueMethod methodPerformEncryption,
			JavaStatement statRetPerformEncryption) {
		CSP _localVariable_0 = _this.isApplicable_solveCsp_BWD(isApplicableMatch, exprNameModePadding,
				exprRetPerformEncryption, keyEncryption, exprDataName, javaPackage, dataEncryption, exprKeyName,
				methodEncryption, jcu, methodPerformEncryption, statRetPerformEncryption);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, exprNameModePadding, exprRetPerformEncryption,
					keyEncryption, exprDataName, javaPackage, dataEncryption, exprKeyName, methodEncryption, jcu,
					methodPerformEncryption, statRetPerformEncryption };
		}
		return null;
	...
	public static final Object[] pattern_SymmetricEncryptionTask_12_4_solveCSP_bindingAndBlackFBBBBBBBBBBBBB(
		...
		Object[] result_pattern_SymmetricEncryptionTask_12_4_solveCSP_binding = pattern_SymmetricEncryptionTask_12_4_solveCSP_bindingFBBBBBBBBBBBBB(
				_this, isApplicableMatch, exprNameModePadding, exprRetPerformEncryption, keyEncryption, exprDataName,
				javaPackage, dataEncryption, exprKeyName, methodEncryption, jcu, methodPerformEncryption,
				statRetPerformEncryption);
	...
	public static final Object[] pattern_SymmetricEncryptionTask_20_2_testcorematchandDECs_black_nac_0BB(Task task,
		...
		for (Algorithm __DEC_task_algorithms_289270 : task.getAlgorithms()) {
			if (!sbc.equals(__DEC_task_algorithms_289270)) {
	...
	public static final Object[] pattern_SymmetricEncryptionTask_21_2_testcorematchandDECs_black_nac_0BB(
		...
		for (JavaStatement __DEC_exprNameModePadding_expr_680553 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(exprNameModePadding, JavaStatement.class, "expr")) {
			if (!statRetPerformEncryption.equals(__DEC_exprNameModePadding_expr_680553)) {
	...
	public static final Object[] pattern_SymmetricEncryptionTask_21_2_testcorematchandDECs_black_nac_1B(
		...
		for (JavaMethodInvocation __DEC_exprRetPerformEncryption_arguments_825502 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(exprRetPerformEncryption, JavaMethodInvocation.class, "arguments")) {
			if (!exprRetPerformEncryption.equals(__DEC_exprRetPerformEncryption_arguments_825502)) {
	...
	public static final Object[] pattern_SymmetricEncryptionTask_21_2_testcorematchandDECs_black_nac_2BB(
		...
		for (JavaStatement __DEC_keyEncryption_expr_380144 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(keyEncryption, JavaStatement.class, "expr")) {
			if (!statRetPerformEncryption.equals(__DEC_keyEncryption_expr_380144)) {
	...
	public static final Object[] pattern_SymmetricEncryptionTask_21_2_testcorematchandDECs_black_nac_3BB(
		...
		for (JavaMethodInvocation __DEC_keyEncryption_arguments_137932 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(keyEncryption, JavaMethodInvocation.class, "arguments")) {
			if (!exprRetPerformEncryption.equals(__DEC_keyEncryption_arguments_137932)) {
	...
	public static final Object[] pattern_SymmetricEncryptionTask_21_2_testcorematchandDECs_black_nac_4BB(
		...
		for (JavaStatement __DEC_exprDataName_expr_65828 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(exprDataName, JavaStatement.class, "expr")) {
			if (!statRetPerformEncryption.equals(__DEC_exprDataName_expr_65828)) {
	...
	public static final Object[] pattern_SymmetricEncryptionTask_21_2_testcorematchandDECs_black_nac_5BB(
		...
		for (JavaCompilationUnit __DEC_javaPackage_cunits_327363 : javaPackage.getCunits()) {
			if (!jcu.equals(__DEC_javaPackage_cunits_327363)) {
	...
	public static final Object[] pattern_SymmetricEncryptionTask_21_2_testcorematchandDECs_black_nac_6BB(
		...
		for (JavaStatement __DEC_dataEncryption_expr_169724 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(dataEncryption, JavaStatement.class, "expr")) {
			if (!statRetPerformEncryption.equals(__DEC_dataEncryption_expr_169724)) {
	...
	public static final Object[] pattern_SymmetricEncryptionTask_21_2_testcorematchandDECs_black_nac_7BB(
		...
		for (JavaMethodInvocation __DEC_dataEncryption_arguments_205791 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(dataEncryption, JavaMethodInvocation.class, "arguments")) {
			if (!exprRetPerformEncryption.equals(__DEC_dataEncryption_arguments_205791)) {
	...
	public static final Object[] pattern_SymmetricEncryptionTask_21_2_testcorematchandDECs_black_nac_8BB(
		...
		for (JavaStatement __DEC_exprKeyName_expr_261783 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(exprKeyName, JavaStatement.class, "expr")) {
			if (!statRetPerformEncryption.equals(__DEC_exprKeyName_expr_261783)) {
	...
	public static final Object[] pattern_SymmetricEncryptionTask_21_2_testcorematchandDECs_black_nac_9BB(
		...
		for (JavaStatement __DEC_methodEncryption_statements_814595 : methodEncryption.getStatements()) {
			if (!statRetPerformEncryption.equals(__DEC_methodEncryption_statements_814595)) {
				...
				if (exprRetPerformEncryption.getArguments().contains(exprKeyName)) {
					...
					if (exprRetPerformEncryption_name.equals("performEncryption")) {
						if (pattern_SymmetricEncryptionTask_21_2_testcorematchandDECs_black_nac_1B(
							...
							for (JavaExpression tmpExprNameModePadding : exprRetPerformEncryption.getArguments()) {
								if (tmpExprNameModePadding instanceof JavaLiteral) {
									JavaLiteral exprNameModePadding = (JavaLiteral) tmpExprNameModePadding;
	...
	public static final boolean pattern_SymmetricEncryptionTask_21_3_bookkeepingwithgenericisAppropriatemethod_expressionFBBBBBBBBBBBBB(
			...
			JavaWorkflowMethod methodEncryption, JavaCompilationUnit jcu, JavaOpaqueMethod methodPerformEncryption,
			JavaStatement statRetPerformEncryption) {
		boolean _localVariable_0 = _this.isAppropriate_BWD(match, exprNameModePadding, exprRetPerformEncryption,
				keyEncryption, exprDataName, javaPackage, dataEncryption, exprKeyName, methodEncryption, jcu,
				methodPerformEncryption, statRetPerformEncryption);
		boolean _result = Boolean.valueOf(_localVariable_0);
		return _result;
	...
	public static final Object[] pattern_SymmetricEncryptionTask_24_2_matchsrctrgcontext_bindingFFFFFFFFFFFFFBB(
		...
		EObject _localVariable_0 = targetMatch.getObject("exprNameModePadding");
		EObject _localVariable_1 = targetMatch.getObject("exprRetPerformEncryption");
		EObject _localVariable_2 = targetMatch.getObject("keyEncryption");
		EObject _localVariable_3 = targetMatch.getObject("exprDataName");
		EObject _localVariable_4 = targetMatch.getObject("javaPackage");
		EObject _localVariable_5 = targetMatch.getObject("dataEncryption");
		EObject _localVariable_6 = sourceMatch.getObject("sbc");
		EObject _localVariable_7 = targetMatch.getObject("exprKeyName");
		EObject _localVariable_8 = targetMatch.getObject("methodEncryption");
		EObject _localVariable_9 = targetMatch.getObject("jcu");
		EObject _localVariable_10 = targetMatch.getObject("methodPerformEncryption");
		EObject _localVariable_11 = sourceMatch.getObject("task");
		EObject _localVariable_12 = targetMatch.getObject("statRetPerformEncryption");
		EObject tmpExprNameModePadding = _localVariable_0;
		EObject tmpExprRetPerformEncryption = _localVariable_1;
		EObject tmpKeyEncryption = _localVariable_2;
		EObject tmpExprDataName = _localVariable_3;
		EObject tmpJavaPackage = _localVariable_4;
		EObject tmpDataEncryption = _localVariable_5;
		EObject tmpSbc = _localVariable_6;
		EObject tmpExprKeyName = _localVariable_7;
		EObject tmpMethodEncryption = _localVariable_8;
		EObject tmpJcu = _localVariable_9;
		EObject tmpMethodPerformEncryption = _localVariable_10;
		EObject tmpTask = _localVariable_11;
		EObject tmpStatRetPerformEncryption = _localVariable_12;
		if (tmpExprNameModePadding instanceof JavaLiteral) {
			JavaLiteral exprNameModePadding = (JavaLiteral) tmpExprNameModePadding;
			if (tmpExprRetPerformEncryption instanceof JavaMethodInvocation) {
				JavaMethodInvocation exprRetPerformEncryption = (JavaMethodInvocation) tmpExprRetPerformEncryption;
											...
											if (tmpJcu instanceof JavaCompilationUnit) {
												...
												if (tmpMethodPerformEncryption instanceof JavaOpaqueMethod) {
													...
													if (tmpTask instanceof Task) {
														...
														if (tmpStatRetPerformEncryption instanceof JavaStatement) {
															JavaStatement statRetPerformEncryption = (JavaStatement) tmpStatRetPerformEncryption;
															return new Object[] { exprNameModePadding,
																	exprRetPerformEncryption, keyEncryption,
																	exprDataName, javaPackage, dataEncryption, sbc,
																	exprKeyName, methodEncryption, jcu,
																	methodPerformEncryption, task,
																	statRetPerformEncryption, targetMatch,
																	sourceMatch };
														}
													}
												}
														...
														if (task_description.equals("SymmetricEncryption")) {
															...
															if (Boolean.valueOf(statRetPerformEncryption_return)
																...
																return new Object[] { exprNameModePadding,
																		...
																		exprKeyName, methodEncryption, jcu,
																		methodPerformEncryption, task,
																		statRetPerformEncryption, sourceMatch,
																		targetMatch };
															}
	...
	public static final Object[] pattern_SymmetricEncryptionTask_24_2_matchsrctrgcontext_bindingAndBlackFFFFFFFFFFFFFBB(
		...
		if (result_pattern_SymmetricEncryptionTask_24_2_matchsrctrgcontext_binding != null) {
			JavaLiteral exprNameModePadding = (JavaLiteral) result_pattern_SymmetricEncryptionTask_24_2_matchsrctrgcontext_binding[0];
			...
			JavaVariableDeclaration keyEncryption = (JavaVariableDeclaration) result_pattern_SymmetricEncryptionTask_24_2_matchsrctrgcontext_binding[2];
			JavaName exprDataName = (JavaName) result_pattern_SymmetricEncryptionTask_24_2_matchsrctrgcontext_binding[3];
			JavaPackage javaPackage = (JavaPackage) result_pattern_SymmetricEncryptionTask_24_2_matchsrctrgcontext_binding[4];
			JavaVariableDeclaration dataEncryption = (JavaVariableDeclaration) result_pattern_SymmetricEncryptionTask_24_2_matchsrctrgcontext_binding[5];
			SymmetricBlockCipher sbc = (SymmetricBlockCipher) result_pattern_SymmetricEncryptionTask_24_2_matchsrctrgcontext_binding[6];
			JavaName exprKeyName = (JavaName) result_pattern_SymmetricEncryptionTask_24_2_matchsrctrgcontext_binding[7];
			JavaWorkflowMethod methodEncryption = (JavaWorkflowMethod) result_pattern_SymmetricEncryptionTask_24_2_matchsrctrgcontext_binding[8];
			JavaCompilationUnit jcu = (JavaCompilationUnit) result_pattern_SymmetricEncryptionTask_24_2_matchsrctrgcontext_binding[9];
			JavaOpaqueMethod methodPerformEncryption = (JavaOpaqueMethod) result_pattern_SymmetricEncryptionTask_24_2_matchsrctrgcontext_binding[10];
			Task task = (Task) result_pattern_SymmetricEncryptionTask_24_2_matchsrctrgcontext_binding[11];
			JavaStatement statRetPerformEncryption = (JavaStatement) result_pattern_SymmetricEncryptionTask_24_2_matchsrctrgcontext_binding[12];
			...
			if (result_pattern_SymmetricEncryptionTask_24_2_matchsrctrgcontext_black != null) {
				...
				return new Object[] { exprNameModePadding, exprRetPerformEncryption, keyEncryption, exprDataName,
						javaPackage, dataEncryption, sbc, exprKeyName, methodEncryption, jcu, methodPerformEncryption,
						task, statRetPerformEncryption, sourceMatch, targetMatch };
			}
		}
		return null;
	}
	...
	public static final Object[] pattern_SymmetricEncryptionTask_24_3_solvecsp_bindingFBBBBBBBBBBBBBBBB(
			SymmetricEncryptionTask _this, JavaLiteral exprNameModePadding,
			JavaMethodInvocation exprRetPerformEncryption, JavaVariableDeclaration keyEncryption, JavaName exprDataName,
			JavaPackage javaPackage, JavaVariableDeclaration dataEncryption, SymmetricBlockCipher sbc,
			JavaName exprKeyName, JavaWorkflowMethod methodEncryption, JavaCompilationUnit jcu,
			JavaOpaqueMethod methodPerformEncryption, Task task, JavaStatement statRetPerformEncryption,
			Match sourceMatch, Match targetMatch) {
		CSP _localVariable_13 = _this.isApplicable_solveCsp_CC(exprNameModePadding, exprRetPerformEncryption,
				keyEncryption, exprDataName, javaPackage, dataEncryption, sbc, exprKeyName, methodEncryption, jcu,
				methodPerformEncryption, task, statRetPerformEncryption, sourceMatch, targetMatch);
		CSP csp = _localVariable_13;
		if (csp != null) {
			return new Object[] { csp, _this, exprNameModePadding, exprRetPerformEncryption, keyEncryption,
					exprDataName, javaPackage, dataEncryption, sbc, exprKeyName, methodEncryption, jcu,
					methodPerformEncryption, task, statRetPerformEncryption, sourceMatch, targetMatch };
		}
		return null;
	}
	...
	public static final Object[] pattern_SymmetricEncryptionTask_24_3_solvecsp_bindingAndBlackFBBBBBBBBBBBBBBBB(
		...
		Object[] result_pattern_SymmetricEncryptionTask_24_3_solvecsp_binding = pattern_SymmetricEncryptionTask_24_3_solvecsp_bindingFBBBBBBBBBBBBBBBB(
				_this, exprNameModePadding, exprRetPerformEncryption, keyEncryption, exprDataName, javaPackage,
				dataEncryption, sbc, exprKeyName, methodEncryption, jcu, methodPerformEncryption, task,
				statRetPerformEncryption, sourceMatch, targetMatch);
	...
	public static final Object[] pattern_SymmetricEncryptionTask_24_6_createcorrespondence_blackBBBBBBBBBBBBBB(
			...
			JavaVariableDeclaration dataEncryption, SymmetricBlockCipher sbc, JavaName exprKeyName,
			JavaWorkflowMethod methodEncryption, JavaCompilationUnit jcu, JavaOpaqueMethod methodPerformEncryption,
			Task task, JavaStatement statRetPerformEncryption, CCMatch ccMatch) {
		if (!exprDataName.equals(exprKeyName)) {
			if (!dataEncryption.equals(keyEncryption)) {
				return new Object[] { exprNameModePadding, exprRetPerformEncryption, keyEncryption, exprDataName,
						javaPackage, dataEncryption, sbc, exprKeyName, methodEncryption, jcu, methodPerformEncryption,
						task, statRetPerformEncryption, ccMatch };
			}
		}
		return null;
	}

	public static final Object[] pattern_SymmetricEncryptionTask_24_6_createcorrespondence_greenBFBFBBB(
			JavaPackage javaPackage, SymmetricBlockCipher sbc, JavaCompilationUnit jcu, Task task, CCMatch ccMatch) {
		SymmetricBlockCipherToJcu sbc2Jcu = CryptoConfigToJavaFactory.eINSTANCE.createSymmetricBlockCipherToJcu();
		TaskToJavaPackage t2c = CryptoConfigToJavaFactory.eINSTANCE.createTaskToJavaPackage();
		sbc2Jcu.setTarget(jcu);
		sbc2Jcu.setSource(sbc);
		...
		return new Object[] { javaPackage, sbc2Jcu, sbc, t2c, jcu, task, ccMatch };
	}
	...
	public static final Object[] pattern_SymmetricEncryptionTask_27_1_matchtggpattern_black_nac_0BB(Task task,
			SymmetricBlockCipher sbc) {
		for (Algorithm __DEC_task_algorithms_798407 : task.getAlgorithms()) {
			if (!sbc.equals(__DEC_task_algorithms_798407)) {
				return new Object[] { task, sbc };
			}
		}
		return null;
	...
	public static final Object[] pattern_SymmetricEncryptionTask_28_1_matchtggpattern_black_nac_0BB(
			JavaLiteral exprNameModePadding, JavaStatement statRetPerformEncryption) {
		for (JavaStatement __DEC_exprNameModePadding_expr_258603 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(exprNameModePadding, JavaStatement.class, "expr")) {
			if (!statRetPerformEncryption.equals(__DEC_exprNameModePadding_expr_258603)) {
				return new Object[] { exprNameModePadding, statRetPerformEncryption };
			}
		}
		return null;
	...
	public static final Object[] pattern_SymmetricEncryptionTask_28_1_matchtggpattern_black_nac_1B(
			JavaMethodInvocation exprRetPerformEncryption) {
		for (JavaMethodInvocation __DEC_exprRetPerformEncryption_arguments_871701 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(exprRetPerformEncryption, JavaMethodInvocation.class, "arguments")) {
			if (!exprRetPerformEncryption.equals(__DEC_exprRetPerformEncryption_arguments_871701)) {
				return new Object[] { exprRetPerformEncryption };
			}
		}
		return null;
	...
	public static final Object[] pattern_SymmetricEncryptionTask_28_1_matchtggpattern_black_nac_2BB(
			JavaVariableDeclaration keyEncryption, JavaStatement statRetPerformEncryption) {
		for (JavaStatement __DEC_keyEncryption_expr_628482 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(keyEncryption, JavaStatement.class, "expr")) {
			if (!statRetPerformEncryption.equals(__DEC_keyEncryption_expr_628482)) {
				return new Object[] { keyEncryption, statRetPerformEncryption };
			}
		}
		return null;
	...
	public static final Object[] pattern_SymmetricEncryptionTask_28_1_matchtggpattern_black_nac_3BB(
			JavaVariableDeclaration keyEncryption, JavaMethodInvocation exprRetPerformEncryption) {
		for (JavaMethodInvocation __DEC_keyEncryption_arguments_389555 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(keyEncryption, JavaMethodInvocation.class, "arguments")) {
			if (!exprRetPerformEncryption.equals(__DEC_keyEncryption_arguments_389555)) {
				return new Object[] { keyEncryption, exprRetPerformEncryption };
			}
		}
		return null;
	...
	public static final Object[] pattern_SymmetricEncryptionTask_28_1_matchtggpattern_black_nac_4BB(
			JavaName exprDataName, JavaStatement statRetPerformEncryption) {
		for (JavaStatement __DEC_exprDataName_expr_454344 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(exprDataName, JavaStatement.class, "expr")) {
			if (!statRetPerformEncryption.equals(__DEC_exprDataName_expr_454344)) {
				return new Object[] { exprDataName, statRetPerformEncryption };
			}
		}
		return null;
	...
	public static final Object[] pattern_SymmetricEncryptionTask_28_1_matchtggpattern_black_nac_5BB(
			JavaPackage javaPackage, JavaCompilationUnit jcu) {
		for (JavaCompilationUnit __DEC_javaPackage_cunits_648449 : javaPackage.getCunits()) {
			if (!jcu.equals(__DEC_javaPackage_cunits_648449)) {
				return new Object[] { javaPackage, jcu };
			}
		}
		return null;
	...
	public static final Object[] pattern_SymmetricEncryptionTask_28_1_matchtggpattern_black_nac_6BB(
			JavaVariableDeclaration dataEncryption, JavaStatement statRetPerformEncryption) {
		for (JavaStatement __DEC_dataEncryption_expr_54879 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(dataEncryption, JavaStatement.class, "expr")) {
			if (!statRetPerformEncryption.equals(__DEC_dataEncryption_expr_54879)) {
				return new Object[] { dataEncryption, statRetPerformEncryption };
			}
		}
		return null;
	...
	public static final Object[] pattern_SymmetricEncryptionTask_28_1_matchtggpattern_black_nac_7BB(
			JavaVariableDeclaration dataEncryption, JavaMethodInvocation exprRetPerformEncryption) {
		for (JavaMethodInvocation __DEC_dataEncryption_arguments_941036 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(dataEncryption, JavaMethodInvocation.class, "arguments")) {
			if (!exprRetPerformEncryption.equals(__DEC_dataEncryption_arguments_941036)) {
				return new Object[] { dataEncryption, exprRetPerformEncryption };
			}
		}
		return null;
	...
	public static final Object[] pattern_SymmetricEncryptionTask_28_1_matchtggpattern_black_nac_8BB(
			JavaName exprKeyName, JavaStatement statRetPerformEncryption) {
		for (JavaStatement __DEC_exprKeyName_expr_419105 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(exprKeyName, JavaStatement.class, "expr")) {
			if (!statRetPerformEncryption.equals(__DEC_exprKeyName_expr_419105)) {
				return new Object[] { exprKeyName, statRetPerformEncryption };
			}
		}
		return null;
	...
	public static final Object[] pattern_SymmetricEncryptionTask_28_1_matchtggpattern_black_nac_9BB(
			JavaWorkflowMethod methodEncryption, JavaStatement statRetPerformEncryption) {
		for (JavaStatement __DEC_methodEncryption_statements_232616 : methodEncryption.getStatements()) {
			if (!statRetPerformEncryption.equals(__DEC_methodEncryption_statements_232616)) {
				return new Object[] { methodEncryption, statRetPerformEncryption };
			}
		}
		return null;
	...
	public static final Object[] pattern_SymmetricEncryptionTask_28_1_matchtggpattern_greenBBBBB(
		...
		methodPerformEncryption.setName(methodPerformEncryption_name_prime);
		statRetPerformEncryption.setReturn(Boolean.valueOf(statRetPerformEncryption_return_prime));
		return new Object[] { exprRetPerformEncryption, keyEncryption, dataEncryption, methodPerformEncryption,
				statRetPerformEncryption };
	}
	...
	public static final Object[] pattern_SymmetricEncryptionTask_29_6_perform_greenFFFFFFFFFFFFFFFBB(
		...
		Object _localVariable_8 = csp.getValue("exprKeyName", "identifier");
		Object _localVariable_9 = csp.getValue("exprKeyName", "index");
		Object _localVariable_10 = csp.getValue("methodEncryption", "throws");
		Object _localVariable_11 = csp.getValue("methodEncryption", "index");
		Object _localVariable_12 = csp.getValue("methodEncryption", "type");
		Object _localVariable_13 = csp.getValue("methodEncryption", "modifier");
		...
		Object _localVariable_18 = csp.getValue("methodPerformEncryption", "modifier");
		Object _localVariable_19 = csp.getValue("methodPerformEncryption", "body");
		Object _localVariable_20 = csp.getValue("methodPerformEncryption", "index");
		String task_description_prime = "SymmetricEncryption";
		...
		String exprKeyName_identifier_prime = (String) _localVariable_8;
		int exprKeyName_index_prime = (int) _localVariable_9;
		String methodEncryption_throws_prime = (String) _localVariable_10;
		int methodEncryption_index_prime = (int) _localVariable_11;
		String methodEncryption_type_prime = (String) _localVariable_12;
		String methodEncryption_modifier_prime = (String) _localVariable_13;
		...
		String methodPerformEncryption_modifier_prime = (String) _localVariable_18;
		String methodPerformEncryption_body_prime = (String) _localVariable_19;
		int methodPerformEncryption_index_prime = (int) _localVariable_20;
		task.setDescription(task_description_prime);
		...
		return new Object[] { exprNameModePadding, exprRetPerformEncryption, keyEncryption, exprDataName, javaPackage,
				sbc2Jcu, dataEncryption, sbc, exprKeyName, methodEncryption, t2c, jcu, methodPerformEncryption, task,
				statRetPerformEncryption, ruleResult, csp };
	}
