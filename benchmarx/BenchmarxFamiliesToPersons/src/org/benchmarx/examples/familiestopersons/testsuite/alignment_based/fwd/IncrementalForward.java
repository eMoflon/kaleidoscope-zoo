...
public class IncrementalForward extends FamiliesToPersonsTestCaseController {
	...
	public void testIncrementalInserts() {
		...
		modelAssertation.assertPrecondition(
				getExpectedFamilyRegister("Pre_IncrFwdFamily"),
				getExpectedPersonRegister("Pre_IncrFwdPerson"),
				syncResult);  
		...
		modelAssertation.assertPostcondition(
				getExpectedFamilyRegister("FamilyAfterInsertion"),
				getExpectedPersonRegister("PersonAfterInsertion"),
				syncResult);  		
	}
	...
	public void testIncrementalDeletions() {
		...
		//------------
		modelAssertation.assertPostcondition(
				getExpectedFamilyRegister("FamilyAfterDeletion"),
				getExpectedPersonRegister("PersonAfterDeletion"),
				syncResult);  
	}
